...
NOT = {
    ...
    "bloklar": [
        ...
        {"tur": "gorsel", "baslik": "Şema 2 — Formülün içindeki sayılar ne anlatır?",
         "aciklama": "Formülde iki farklı sayı vardır ve **ikisi aynı şeyi "
                     "anlatmaz**: önündeki **katsayı** kaç molekül olduğunu, "
                     "harfin sağ altındaki **alt indis** o molekülde o elementten "
                     "kaç atom bulunduğunu söyler.",
         "ciz": S.kartlar([
             ("Katsayı", "formülün **önünde**\nkaç molekül var"),
             ("Alt indis", "sembolün **sağ altında**\nkaç atom var"),
             ("Parantez indisi", "parantez içindeki\n**hepsini** çarpar"),
             ("3H_2O", "**3 molekül** su\n6 H + 3 O atomu"),
             ("Ca(OH)_2", "1 Ca + **2 O** + **2 H**\nyani 5 atom"),
             ("2Al_2(SO_4)_3", "2 × (2 Al + 3 S + 12 O)\n= **34 atom**"),
         ], sutun=3)},
        {"tur": "maddeler", "ogeler": [
            "**Element**: Aynı cins atomlardan oluşan saf madde. **Sembolle** "
            "gösterilir.",
            "**Sembol kuralı**: İlk harf **büyük**, varsa ikinci harf **küçük** "
            "yazılır. **Na** doğru, **N_A** ya da **na** yanlıştır.",
            ...
            "H_2SO_4 → 2 hidrojen, 1 kükürt, 4 oksijen atomu.",
            "Formülün **önündeki katsayı** molekül sayısını gösterir. **3H_2O** → "
        ...
        {"tur": "tablo",
         ...
         "satirlar": [
             ...
             ["Kalsiyum karbonat", "CaCO_3", "**Kireç taşı, mermer**"],
             ["Kalsiyum oksit", "CaO", "**Sönmemiş kireç**"],
             ["Sodyum bikarbonat", "NaHCO_3", "**Karbonat (kabartma tozu)**"],
             ["Sülfürik asit", "H_2SO_4", "**Zaç yağı**"],
             ["Hidroklorik asit", "HCl", "**Tuz ruhu**"],
             ["Asetik asit", "CH_3COOH", "**Sirke asidi**"],
             ["Etil alkol", "C_2H_5OH", "**Alkol**"],
             ["Amonyak", "NH_3", "—"],
         ]},
        {"tur": "cozum",
         "baslik": "Atom Sayısı Hesabı",
         "soru": "**2Al_2(SO_4)_3** gösteriminde toplam kaç atom vardır?",
         "adimlar": [
             "Parantez dışındaki **3** sayısı, parantez içindeki her atomu **3 ile** "
             "çarpar: (SO_4) → 3 kükürt, 12 oksijen.",
    ...
    "fasikul": {
        ...
        "sorular": [
            ...
            "H_2SO_4 formülünde her elementten kaçar atom bulunur?",
            "3H_2O gösteriminde toplam kaç atom vardır?",
            "Ca(OH)_2 formülünde toplam kaç atom bulunur?",
            "2Al_2(SO_4)_3 gösteriminde toplam atom sayısını hesaplayınız.",
        ...
        "cevaplar": [
            ...
            "İkinci harf **küçük** olmalıdır; doğrusu **Na**'dır. 'N_A' iki ayrı elementin sembolü gibi okunur.",
            ...
            "Yemek tuzu **NaCl**, sud kostik **NaOH**, kireç taşı **CaCO_3**.",
            "Tuz ruhu **hidroklorik asit (HCl)**, zaç yağı **sülfürik asit (H_2SO_4)**, sirke asidi **asetik asit (CH_3COOH)**.",
            "**CaO** — sönmemiş kireç.",
            "**Sodyum bikarbonat (NaHCO_3)**.",
