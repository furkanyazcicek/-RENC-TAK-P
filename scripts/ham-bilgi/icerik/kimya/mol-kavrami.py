...
NOT = {
    ...
    "bloklar": [
        ...
        {"tur": "gorsel", "baslik": "Şema 1 — Mol, dört büyüklüğü birbirine bağlayan merkez",
         "aciklama": "Mol soruları neredeyse her zaman **bir büyüklükten mole, "
                     "molden başka bir büyüklüğe** geçmekten ibarettir. Bu yüzden "
                     "önce verileni mole çevir, sonra istenene git. Hacim bağıntısı "
                     "yalnızca **normal koşullardaki gazlar** için geçerlidir.",
         "ciz": S.kartlar([
             ("Kütle → mol", "n = **m / M_A**\ngram / mol kütlesi"),
             ("Mol → kütle", "m = **n · M_A**"),
             ("Tanecik → mol", "n = **N / 6,02·10^(23)**"),
             ("Mol → tanecik", "N = **n · 6,02·10^(23)**"),
             ("Hacim → mol (NK)", "n = **V / 22,4**\nyalnızca gazlarda"),
             ("Mol → hacim (NK)", "V = **n · 22,4** litre"),
         ], sutun=3)},
        ...
        {"tur": "maddeler", "ogeler": [
            ...
            "elektron.",
            "**Mol kütlesi (M_A)**: 1 molün gram cinsinden kütlesi. Periyodik "
        ...
        {"tur": "formul",
         ...
         "ifade": "n = m / M_A        n = N / 6,02×10 üzeri 23        n = V / 22,4",
         "terimler": [
             ("n", "**Mol sayısı**"),
             ("m", "**Kütle** (gram)"),
        ...
        {"tur": "cozum",
         ...
         "soru": "**Ca(OH)_2** bileşiğinin mol kütlesini hesaplayınız. "
                 "(Ca = 40, O = 16, H = 1)",
         "adimlar": [
         ...
         "sonuc": "Ca(OH)_2'nin mol kütlesi 74 g/mol'dür."},
        {"tur": "cozum",
         "baslik": "Kütleden Tanecik Sayısına",
         "soru": "**88 g CO_2** gazında kaç **molekül** ve kaç **atom** bulunur? "
                 "(C = 12, O = 16)",
         "adimlar": [
             "Önce mol kütlesini bul: CO_2 → 12 + (2 × 16) = **44 g/mol**.",
             "Mol sayısını bul: n = m / M_A = 88 / 44 = **2 mol**.",
             "Molekül sayısı: 2 × 6,02×10 üzeri 23 = **1,204 × 10 üzeri 24 molekül**.",
             "Bir CO_2 molekülünde **3 atom** var (1 C + 2 O).",
        ...
        {"tur": "maddeler", "ogeler": [
            ...
            "Bu değer **gazın cinsinden bağımsızdır**: 1 mol O_2 de, 1 mol CO_2 de, "
        ...
        {"tur": "cozum",
         ...
         "soru": "Normal koşullarda **11,2 litre** oksijen gazının (O_2) kütlesi "
                 "kaç gramdır? (O = 16)",
         "adimlar": [
             "Mol sayısını bul: n = V / 22,4 = 11,2 / 22,4 = **0,5 mol**.",
             "O_2'nin mol kütlesi: 2 × 16 = **32 g/mol**.",
             "Kütleyi bul: m = n × M_A = 0,5 × 32.",
         ],
         "sonuc": "16 gram."},
        ...
        {"tur": "cozum",
         ...
         "adimlar": [
             ...
             "**Basit formül = CH_2O**. Basit formül kütlesi = 12 + 2 + 16 = **30**.",
             "n = 180 / 30 = **6**. Molekül formülü = (CH_2O) × 6.",
         ],
         "sonuc": "Basit formül CH_2O, molekül formülü C_6H_12O_6 (glikoz)."},
        ...
        {"tur": "maddeler", "ogeler": [
            ...
            "2H_2 + O_2 → 2H_2O denkleminde **2 mol H_2, 1 mol O_2 ile** tepkir ve "
            "**2 mol su** oluşur.",
        ...
        {"tur": "cozum",
         ...
         "soru": "**N_2 + 3H_2 → 2NH3** tepkimesinde **2 mol N_2** ile **9 mol H_2** "
                 "kullanılıyor. Kaç mol NH_3 oluşur, hangi madde artar?",
         "adimlar": [
             "Her maddenin mol sayısını **kendi katsayısına böl**: "
             "N_2 → 2/1 = **2** · H_2 → 9/3 = **3**.",
             "Daha **küçük** olan sınırlayıcıdır → **N_2 tükenir**, H_2 artar.",
             "2 mol N_2, katsayı oranına göre **6 mol H_2** harcar (1'e 3).",
             "Artan H_2 = 9 − 6 = **3 mol**.",
             "Oluşan NH_3: N_2 katsayısı 1'e karşılık NH_3 katsayısı 2 → 2 × 2 = **4 mol**.",
         ],
         "sonuc": "4 mol NH_3 oluşur, 3 mol H_2 artar."},
        {"tur": "cikmis", "baslik": "Sınırlayıcı bileşen tuzağı", "govde":
            "Sınırlayıcıyı bulurken **mol sayılarını doğrudan karşılaştırma**. "
            "9 mol H_2, 2 mol N_2'den çoktur ama tepkimede **3 katı** gerektiği için "
            "yine de artan odur. Her zaman **mol sayısını katsayıya böl**, sonra "
            "karşılaştır."},

        {"tur": "ezber", "baslik": "Sınav Öncesi Son Bakış", "ogeler": [
            "1 mol = **6,02 × 10 üzeri 23** tanecik.",
            "**n = m/M_A**, **n = N/6,02×10 üzeri 23**, **n = V/22,4** (gaz + NK).",
    ...
    "fasikul": {
        ...
        "sorular": [
            ...
            "H_2SO_4'ün mol kütlesini hesaplayınız.",
            "Ca(OH)_2'nin mol kütlesini hesaplayınız.",
            "CaCO_3'ün mol kütlesini hesaplayınız.",
            "44 g CO_2 kaç moldür?",
            "3 mol H_2O kaç gramdır?",
            "1,204 × 10 üzeri 24 tane su molekülü kaç moldür?",
            "0,5 mol NH_3 kaç molekül içerir?",
            "88 g CO_2 gazında kaç molekül bulunur?",
            "Aynı örnekte toplam kaç atom bulunur?",
            "Aynı örnekte kaç oksijen atomu vardır?",
            "1 mol O_2 gazında kaç mol oksijen atomu vardır?",
            "Soy gazlarda molekül sayısı ile atom sayısı arasındaki ilişkiyi yazınız.",
            "Normal koşullarda 11,2 L O_2 gazı kaç gramdır?",
            "Normal koşullarda 5,6 L CH_4 gazı kaç moldür?",
            "Normal koşullarda 64 g O_2 gazı kaç litre hacim kaplar?",
            "Avogadro hipotezini bir cümleyle yazınız.",
            "Normal koşullarda eşit hacimli O_2 ve CO_2 gazlarının mol sayıları eşit midir?",
            ...
            "CaCO_3'te kalsiyumun kütlece yüzdesini bulunuz.",
            "H_2O'da oksijenin kütlece yüzdesini bulunuz.",
            ...
            "2H_2 + O_2 → 2H_2O tepkimesinde 4 mol H_2'den kaç mol su oluşur?",
            "Aynı tepkimede 4 mol H_2 için kaç mol O_2 gerekir?",
            "Sınırlayıcı bileşen kavramını tanımlayınız.",
            "Sınırlayıcı bileşen nasıl bulunur? Adımı yazınız.",
            "N_2 + 3H_2 → 2NH3 tepkimesinde 2 mol N_2 ve 9 mol H_2 varsa hangi madde sınırlayıcıdır?",
            "Aynı soruda kaç mol NH_3 oluşur ve kaç mol madde artar?",
        ...
        "cevaplar": [
            ...
            "CO_2'nin mol kütlesi 44 → n = 44/44 = **1 mol**.",
            "H_2O = 18 g/mol → m = 3 × 18 = **54 g**.",
            ...
            "Bir CO_2'de 3 atom var → 1,204×10 üzeri 24 × 3 = **3,612 × 10 üzeri 24 atom**.",
            "Bir CO_2'de 2 oksijen var → 1,204×10 üzeri 24 × 2 = **2,408 × 10 üzeri 24 oksijen atomu**.",
            "**2 mol** oksijen atomu (O_2 iki atomludur).",
            ...
            "**Eşit değildir.** Mol sayıları eşit olsa da **mol kütleleri farklıdır** (O_2 = 32, CO_2 = 44); bu yüzden kütleleri farklı olur.",
            ...
            "(40 / 100) × 100 = **%40**.",
            "(16 / 18) × 100 = **%88,9**.",
            "**Basit formül** atomların en küçük tam sayılı oranını gösterir (CH_2O). **Molekül formülü** gerçekte kaç atom bulunduğunu gösterir (C_6H_12O_6).",
            ...
            "C: 85,7/12 = 7,14 · H: 14,3/1 = 14,3. En küçüğe bölünce 1 : 2 → **CH_2**.",
            ...
            "Katsayı oranı H_2 : H_2O = 2 : 2 = 1 : 1 → **4 mol su**.",
            "Katsayı oranı H_2 : O_2 = 2 : 1 → **2 mol O_2**.",
            ...
            "N_2: 2/1 = 2 · H_2: 9/3 = 3. Küçük olan **N_2 sınırlayıcıdır**.",
            "**4 mol NH_3** oluşur; **3 mol H_2** artar.",
            "Tepkime **mol oranıyla** yürür, mol sayısıyla değil. 9 mol H_2 sayıca çok olsa da tepkime N_2'nin 3 katı H_2 istediği için 2 mol N_2 yalnızca 6 mol H_2 harcar; geri kalan artar.",
        ],
    },
}
