...
import DersBloklari from '../../components/ispanyolca/DersBloklari'
import Alistirma from '../../components/ispanyolca/alistirmalar/Alistirma'
import YazmaGorevi from '../../components/ispanyolca/alistirmalar/YazmaGorevi'
...
import { dersBul, dersKelimeleri, modulDestesi, notBul } from '../../content/ispanyolca'
import { DURUM } from '../../lib/ispanyolca/cevap'
import {
  beceriGuncelle, dersBasla, dersTamamla, DURUMLAR, DURUM_ETIKETLERI, yazmaKaydet,
} from '../../lib/ispanyolca/ilerleme'
import { BECERILER } from '../../lib/ispanyolca/seviyeler'
 ...
 * oranına göre belirlenir (bkz. lib/ispanyolca/ilerleme.js `dersTamamla`).
 */
...
export default function Ders() {
  ...
  return (
    <AppShell
      ...
      width="narrow"
      headerAction={
        <Button as={Link} to="/ispanyolca/kutuphane" variant="ghost" size="sm">
          Kütüphane
        </Button>
      }
    >
      ...
      {asama === 'ozet' && (
        <>
          ...
          <DersKartlari
            ...
            kartlarYolu="/ispanyolca/kartlar"
            dilKodu="es"
      ...
      {asama === 'bitis' && sonuc && (
        <Bitis
          ...
          onSonraki={() => {
            if (ders.sonraki) {
              yonlendir(`/ispanyolca/ders/${ders.sonraki}`)
              sifirla()
            } else {
              yonlendir('/ispanyolca')
            }
          }}
        />
      )}
    ...
    <>
      ...
      {izler.length > 0 && (
        <section className="rounded-card border border-line bg-surface p-5 shadow-card">
          ...
          <Button as={Link} to="/ispanyolca/dusunme" variant="secondary" size="sm" className="mt-3">
