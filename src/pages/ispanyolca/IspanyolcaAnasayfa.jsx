...
import { DERSLER, KELIME_HAVUZU } from '../../content/ispanyolca'
import { baslangicTamamMi, seriHesapla, tespitTamamMi } from '../../lib/ispanyolca/ilerleme'
import { SEVIYELER } from '../../lib/ispanyolca/seviyeler'
import { bekleyenSayisi } from '../../lib/ispanyolca/tekrar'
import { baslangicSeviyesi, bugunPlani, seviyeTamamlanmaDurumu } from '../../lib/ispanyolca/yolHaritasi'

/**
 * İspanyolca ana sayfası.
 *
...
export default function IspanyolcaAnasayfa() {
...
function Tanitim() {
  return (
    ...
    >
      <DashboardHero
        eyebrow="İspanyolca Öğrenme Kütüphanesi"
      ...
      <section className="rounded-card bg-surface-muted p-5 ring-1 ring-inset ring-line sm:p-6">
        ...
        <p className="mt-2 text-[0.95rem] leading-relaxed text-ink/70">
          ...
          durum verir ve o durumda İspanyolca ne söylendiğini sorar. Yanlış yaptığında da yalnız
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <Button as={Link} to="/ispanyolca/baslangic" size="lg" icon={Sparkles} className="justify-center">
          Başlayalım
        </Button>
        <Button as={Link} to="/ispanyolca/kilavuz" size="lg" variant="secondary" className="justify-center">
...
function TespitBekliyor({ ilerleme }) {
  ...
  return (
    <AppShell title="İspanyolca" subtitle="Sıradaki adım: seviye tespiti" width="narrow">
      <DashboardHero
      ...
      <div className="rounded-card border border-line bg-surface p-5 shadow-card sm:p-6">
        ...
        <ul className="mt-3 grid gap-2 sm:grid-cols-2">
          {[
            ...
            'Okuduğunu anlama',
            'Dinlediğini anlama (cihazında İspanyolca ses varsa)',
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <Button as={Link} to="/ispanyolca/seviye-tespit" size="lg" icon={Target} className="justify-center">
          Seviye tespitine başla
        </Button>
        <Button as={Link} to="/ispanyolca/kutuphane" size="lg" variant="secondary" className="justify-center">
          Sınavsız devam et
        </Button>
      </div>
    </AppShell>
...
function GunlukAkis({ ilerleme }) {
  ...
  return (
    <AppShell
      ...
      headerAction={
        <Button as={Link} to="/ispanyolca/gelisim" variant="ghost" size="sm" icon={LineChart}>
          Gelişimim
        </Button>
      }
    >
      ...
      <section>
        ...
        {gorevler.length === 0 ? (
          <div className="mt-3 rounded-card border border-line bg-surface p-6 text-center shadow-card">
            ...
            <Button as={Link} to="/ispanyolca/kutuphane" variant="secondary" className="mt-4">
              Kütüphaneye git
            </Button>
          </div>
        ) : (
