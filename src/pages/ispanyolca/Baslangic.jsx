...
import { profilKaydet } from '../../lib/ispanyolca/ilerleme'
import { BECERILER } from '../../lib/ispanyolca/seviyeler'
import { YOGUNLUKLAR } from '../../lib/ispanyolca/yolHaritasi'
...
const ADIMLAR = [
  {
    anahtar: 'amac',
    soru: 'İspanyolcayı ne için öğreniyorsun?',
    ...
    secenekler: [
      ...
      { deger: 'konusma', ad: 'Konuşabilmek', not: 'Dinleme, telaffuz ve İspanyolca düşünme ağırlıklı' },
      { deger: 'seyahat', ad: 'Seyahat ve günlük hayat', not: 'Kalıplar, durumlar, dinleme' },
      { deger: 'akademik', ad: 'Akademik İspanyolca', not: 'Okuma, yazma ve akademik kelime' },
      { deger: 'meslek', ad: 'İş hayatı', not: 'Yazışma, sunum, mesleki kelime' },
    ],
  },
  {
    anahtar: 'oncekiDeneyim',
    soru: 'Daha önce İspanyolca öğrendin mi?',
...
export default function Baslangic() {
  ...
  const bitir = () => {
    ...
    yonlendir('/ispanyolca/seviye-tespit')
  }

  return (
    <AppShell title="İspanyolca" subtitle="Önce seni tanıyalım" width="narrow">
      <div>
