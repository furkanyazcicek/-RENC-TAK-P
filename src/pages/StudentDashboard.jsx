...
export default function StudentDashboard() {
  ...
  const [librarySubjects, setLibrarySubjects] = useState([]) // müfredat dersleri (LGS/TYT/AYT/KPSS)
  ...
  const loadData = useCallback(async () => {
    if (!user) return
    const [examsRes, mockExamsRes, questionsRes, dailyLogsRes, librarySubjectsRes, libraryTopicsRes] = await Promise.all([
  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 py-6 flex flex-col gap-6">
        ...
        <div className="rounded-xl2 bg-white shadow-card border border-line p-5">
