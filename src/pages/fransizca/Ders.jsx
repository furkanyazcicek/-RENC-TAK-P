...
import DersBloklari from '../../components/fransizca/DersBloklari'
 ...
 * oranına göre belirlenir (bkz. lib/fransizca/ilerleme.js `dersTamamla`).
 */
...
export default function Ders() {
  ...
  return (
    <AppShell
      ...
      width="narrow"
      headerAction={
        <Button as={Link} to="/fransizca/kutuphane" variant="ghost" size="sm">
          Kütüphane
        </Button>
      }
    >
      ...
      {asama === 'bitis' && sonuc && (
        <Bitis
          ...
          onSonraki={() => {
            if (ders.sonraki) {
              yonlendir(`/fransizca/ders/${ders.sonraki}`)
              sifirla()
            } else {
              yonlendir('/fransizca')
            }
