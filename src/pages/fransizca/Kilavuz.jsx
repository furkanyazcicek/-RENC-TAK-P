  ...
  return (
    ...
    >
      ...
      <Bolum
        ...
        maddeler={[
          'Hiç Fransızca bilmiyorsan: "Başlayalım" → seviye tespiti → ilk ders. Alfabe dersinden başlanır.',
          'Okul Fransızcan varsa: seviye tespitine gir. Sonuç seni doğru yere koyacak; kolay gelirse hızlı geçersin.',
          'Anlıyor ama konuşamıyorsan: tespitten sonra "Fransızca düşünme" antrenmanlarına ağırlık ver.',
      ...
      <Bolum
        ...
        metin="Dinleme ve telaffuz çalışmaları cihazının kendi Fransızca sesini kullanır. Cihazında Fransızca ses yoksa uygulama bunu açıkça söyler ve dinleme içeriklerini yazılı biçimde açar — çalışmayan bir oynatıcı göstermeyiz. Telefonda Ayarlar → Erişilebilirlik → Konuşma bölümünden Fransızca ses indirebilirsin."
      />
      ...
      <section>
        ...
        <div className="mt-3 grid gap-2.5">
          {[
            { Icon: Target, ad: 'Seviye tespiti', not: 'Nerede olduğunu ölçer. İstersen sonra tekrar girebilirsin.', to: '/fransizca/seviye-tespit' },
            { Icon: CalendarCheck, ad: 'Yol haritam', not: 'Bugün, bu hafta, bu ay ne yapacağın ve seviyeyi ne zaman bitireceğin.', to: '/fransizca/yol-haritasi' },
            { Icon: LibraryBig, ad: 'Ders kütüphanesi', not: 'Bütün seviyeler ve modüller. İstediğin dersi sıradan bağımsız açabilirsin.', to: '/fransizca/kutuphane' },
            { Icon: RefreshCw, ad: 'Kelime ve tekrar', not: 'Aralıklı tekrar oturumu. Günde 5 dakika yeter.', to: '/fransizca/tekrar' },
            { Icon: Mic, ad: 'Telaffuz laboratuvarı', not: 'Türkçede olmayan sesler, vurgu, ritim, gölge okuma ve kendi kaydın.', to: '/fransizca/telaffuz' },
            { Icon: BrainCircuit, ad: 'Fransızca düşünme', not: 'Çeviri alışkanlığını kıran antrenmanlar ve hata defterin.', to: '/fransizca/dusunme' },
            { Icon: Compass, ad: 'Gelişimim', not: 'Beceri beceri durumun, ders durumların ve kelime kalıcılığın.', to: '/fransizca/gelisim' },
          ].map(({ Icon, ad, not, to }) => (
            <Link
              key={to}
              to={to}
      ...
      <section className="rounded-card bg-surface-muted p-5 ring-1 ring-inset ring-line">
        ...
        <p className="mt-1.5 text-sm leading-relaxed text-ink/65">
          Oturum açıkken Fransızca ilerlemen hesabına bağlıdır ve diğer cihazlarında da güncellenir.
        ...
        <Button as={Link} to="/fransizca/gelisim" variant="secondary" size="sm" className="mt-3">
          Gelişim ekranına git
        </Button>
      </section>

      <div className="flex flex-col gap-2.5 sm:flex-row">
        <Button as={Link} to="/fransizca" size="lg" className="justify-center">
          Anladım, başlayalım
        </Button>
      </div>
    </AppShell>
