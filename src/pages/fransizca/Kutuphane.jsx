...
import { DERSLER, kutuphaneAgaci, modulNotlari } from '../../content/fransizca'
import { DURUMLAR, DURUM_ETIKETLERI } from '../../lib/fransizca/ilerleme'
import { BECERILER, SEVIYELER, SEVIYE_SIRASI } from '../../lib/fransizca/seviyeler'
import { baslangicSeviyesi } from '../../lib/fransizca/yolHaritasi'
  ...
  return (
    ...
    >
      ...
      {acik && hazir && calismaKagidi && (
        <Link
          to={`/fransizca/yazdir/${calismaKagidi.id}`}
