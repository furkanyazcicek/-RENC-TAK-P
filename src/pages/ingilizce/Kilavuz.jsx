  ...
  return (
    ...
    >
      ...
      <Bolum
        ...
        maddeler={[
          'Hiç İngilizce bilmiyorsan: "Başlayalım" → seviye tespiti → ilk ders. Alfabe dersinden başlanır.',
          'Okul İngilizcen varsa: seviye tespitine gir. Sonuç seni doğru yere koyacak; kolay gelirse hızlı geçersin.',
          'Anlıyor ama konuşamıyorsan: tespitten sonra "İngilizce düşünme" antrenmanlarına ağırlık ver.',
      ...
      <Bolum
        ...
        metin="Dinleme ve telaffuz çalışmaları cihazının kendi İngilizce sesini kullanır. Cihazında İngilizce ses yoksa uygulama bunu açıkça söyler ve dinleme içeriklerini yazılı biçimde açar — çalışmayan bir oynatıcı göstermeyiz. Telefonda Ayarlar → Erişilebilirlik → Konuşma bölümünden İngilizce ses indirebilirsin."
      />
      ...
      <section>
        ...
        <div className="mt-3 grid gap-2.5">
          {[
            { Icon: Target, ad: 'Seviye tespiti', not: 'Nerede olduğunu ölçer. İstersen sonra tekrar girebilirsin.', to: '/ingilizce/seviye-tespit' },
            { Icon: CalendarCheck, ad: 'Yol haritam', not: 'Bugün, bu hafta, bu ay ne yapacağın ve seviyeyi ne zaman bitireceğin.', to: '/ingilizce/yol-haritasi' },
            { Icon: LibraryBig, ad: 'Ders kütüphanesi', not: 'Bütün seviyeler ve modüller. İstediğin dersi sıradan bağımsız açabilirsin.', to: '/ingilizce/kutuphane' },
            { Icon: RefreshCw, ad: 'Kelime ve tekrar', not: 'Aralıklı tekrar oturumu. Günde 5 dakika yeter.', to: '/ingilizce/tekrar' },
            { Icon: Mic, ad: 'Telaffuz laboratuvarı', not: 'Türkçede olmayan sesler, vurgu, ritim, gölge okuma ve kendi kaydın.', to: '/ingilizce/telaffuz' },
            { Icon: BrainCircuit, ad: 'İngilizce düşünme', not: 'Çeviri alışkanlığını kıran antrenmanlar ve hata defterin.', to: '/ingilizce/dusunme' },
            { Icon: Compass, ad: 'Gelişimim', not: 'Beceri beceri durumun, ders durumların ve kelime kalıcılığın.', to: '/ingilizce/gelisim' },
          ].map(({ Icon, ad, not, to }) => (
            <Link
              key={to}
              to={to}
      ...
      <div className="flex flex-col gap-2.5 sm:flex-row">
        <Button as={Link} to="/ingilizce" size="lg" className="justify-center">
          Anladım, başlayalım
        </Button>
      </div>
    </AppShell>
