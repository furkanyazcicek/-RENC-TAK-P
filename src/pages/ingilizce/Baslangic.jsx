...
import { profilKaydet } from '../../lib/ingilizce/ilerleme'
import { BECERILER } from '../../lib/ingilizce/seviyeler'
import { YOGUNLUKLAR } from '../../lib/ingilizce/yolHaritasi'
...
const ADIMLAR = [
  {
    anahtar: 'amac',
    soru: 'İngilizceyi ne için öğreniyorsun?',
    ...
    secenekler: [
      ...
      { deger: 'konusma', ad: 'Konuşabilmek', not: 'Dinleme, telaffuz ve İngilizce düşünme ağırlıklı' },
      { deger: 'seyahat', ad: 'Seyahat ve günlük hayat', not: 'Kalıplar, durumlar, dinleme' },
      { deger: 'akademik', ad: 'Akademik İngilizce', not: 'Okuma, yazma ve akademik kelime' },
      { deger: 'meslek', ad: 'İş hayatı', not: 'Yazışma, sunum, mesleki kelime' },
    ],
  },
  {
    anahtar: 'oncekiDeneyim',
    soru: 'Daha önce İngilizce öğrendin mi?',
...
export default function Baslangic() {
  ...
  const bitir = () => {
    ...
    yonlendir('/ingilizce/seviye-tespit')
  }

  return (
    <AppShell title="İngilizce" subtitle="Önce seni tanıyalım" width="narrow">
      <div>
