...
import { ANTRENMANLAR, IC_SES_GOREVLERI } from '../../content/ingilizce'
import { DURUM } from '../../lib/ingilizce/cevap'
import { beceriGuncelle, gunlukKaydet, sikIzler } from '../../lib/ingilizce/ilerleme'
import { izBul } from '../../lib/ingilizce/turkceIzleri'

/**
 * İngilizce düşünme antrenmanları.
 *
 ...
 * "şu Türkçe cümleyi İngilizceye çevir" demez. Bir durum, bir niyet, bir
 * İngilizce tanım ya da bir İngilizce soru verilir; cevap doğrudan
 * İngilizce üretilir.
 *
    ...
    >
      <section className="rounded-card bg-accent-500/[0.06] p-5 ring-1 ring-inset ring-accent-500/15 sm:p-6">
        ...
        <p className="mt-2.5 text-[0.98rem] leading-relaxed text-ink/75">
          ...
          İngilizceye taşıdığı için hataya yol açar.
        </p>
        <p className="mt-2 text-[0.95rem] leading-relaxed text-ink/70">
          ...
          <strong className="font-semibold text-ink">ürettiğin şey hep İngilizce</strong> ve hiçbir
      ...
      <section className="rounded-card bg-surface-muted p-5 ring-1 ring-inset ring-line">
        ...
        <p className="mt-1.5 text-sm leading-relaxed text-ink/65">
          ...
          ve İngilizce düşünmeye geçişin asıl gerçekleştiği yer burasıdır.
        </p>
    ...
    return (
      <AppShell title={antrenman.ad} subtitle="Antrenman tamamlandı" width="narrow">
        <section className="rounded-card bg-success-500/[0.07] p-6 ring-1 ring-inset ring-success-500/20">
          ...
          <p className="mt-2 text-[0.95rem] leading-relaxed text-ink/70">
            Bu antrenmanda hiç Türkçe cümle çevirmedin — hepsini doğrudan İngilizce ürettin.
