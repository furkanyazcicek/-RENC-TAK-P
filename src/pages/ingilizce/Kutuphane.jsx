...
import { DERSLER, kutuphaneAgaci, modulNotlari } from '../../content/ingilizce'
import { DURUMLAR, DURUM_ETIKETLERI } from '../../lib/ingilizce/ilerleme'
import { BECERILER, SEVIYELER, SEVIYE_SIRASI } from '../../lib/ingilizce/seviyeler'
import { baslangicSeviyesi } from '../../lib/ingilizce/yolHaritasi'
  ...
  return (
    ...
    >
      ...
      {acik && hazir && calismaKagidi && (
        <Link
          to={`/ingilizce/yazdir/${calismaKagidi.id}`}
