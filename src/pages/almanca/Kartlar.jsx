  ...
  return (
    ...
    >
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-2xl text-sm leading-relaxed text-ink/65">
              Kartın ön yüzünde Almanca kelime var. Anlamını hatırlamaya çalış,
      ...
      <p className="text-sm leading-relaxed text-ink/50">
        ...
        ilerlemek istersen{' '}
        <Link to="/almanca/kutuphane" className="focus-ring rounded font-semibold text-brand-700 underline-offset-2 hover:underline">
          ders kütüphanesine
        </Link>{' '}
        bak; unutmamak için tekrar etmek istersen{' '}
        <Link to="/almanca/tekrar" className="focus-ring rounded font-semibold text-brand-700 underline-offset-2 hover:underline">
          kelime ve tekrar
        </Link>{' '}
        bölümünü kullan.
      </p>
  ...
  return (
    <AppShell title={deste.ad} subtitle={deste.aciklama}>
      ...
      >
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="min-w-0">
            <p className="font-display text-2xl font-bold leading-tight text-ink sm:text-[1.75rem]" lang="de">
              {kart.on}
            </p>
            {kart.okunus && (
        ...
        {!cevrildi ? (
          ...
          <div className="mt-5 border-t border-line pt-5">
            ...
            <div className="mt-1.5 flex flex-wrap items-start gap-2.5">
              <p className="min-w-0 flex-1 text-[1.02rem] leading-relaxed text-ink" lang="de">
                {kart.ornek}
              </p>
              <span onClick={(o) => o.stopPropagation()} role="presentation">
