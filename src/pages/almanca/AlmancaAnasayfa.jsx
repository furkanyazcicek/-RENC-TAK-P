...
function TespitBekliyor({ ilerleme }) {
  ...
  return (
    <AppShell title="Almanca" subtitle="Sıradaki adım: seviye tespiti" width="narrow" showPageIntro={false}>
      <DashboardHero
        asPageHeader
      ...
      <section>
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-2">
          {[
            ...
            { to: '/almanca/kartlar', Icon: Layers, ad: 'Dil kartları', not: 'İlgi alanına göre desteler — çevir, karşılığını ve örneği gör' },
