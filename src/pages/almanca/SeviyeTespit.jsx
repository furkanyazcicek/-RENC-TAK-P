...
import { TESPIT_MADDELERI, TESPIT_YAZMA_GOREVI } from '../../content/almanca'
import { tespitKaydet } from '../../lib/almanca/ilerleme'
import {
  bosOturum, cevapIsle, sonrakiSoru, sonucla, SORU_BUTCESI, yazmaEkle,
} from '../../lib/almanca/seviyeTespit'
    ...
    <AppShell title="Seviye tespiti" subtitle="Son adım: kısa yazma" width="narrow">
      <section className="rounded-card border border-line bg-surface p-5 shadow-card sm:p-6">
        ...
        <p className="mt-2 text-[0.95rem] leading-relaxed text-ink/70">
          Almanca yaz: kim olduğun, nerede yaşadığın, ne yaptığın ve neden Almanca öğrendiğin.
        ...
        <Textarea
          ...
          rows={8}
          lang="de"
          placeholder="Schreib etwas über dich auf Deutsch…"
