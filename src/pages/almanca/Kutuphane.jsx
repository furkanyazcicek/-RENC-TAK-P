...
import { DERSLER, kutuphaneAgaci, modulNotlari } from '../../content/almanca'
import { DURUMLAR, DURUM_ETIKETLERI } from '../../lib/almanca/ilerleme'
import { BECERILER, SEVIYELER, SEVIYE_SIRASI } from '../../lib/almanca/seviyeler'
import { baslangicSeviyesi } from '../../lib/almanca/yolHaritasi'
  ...
  return (
    ...
    >
      ...
      {acik && hazir && calismaKagidi && (
        <Link
          to={`/almanca/yazdir/${calismaKagidi.id}`}
