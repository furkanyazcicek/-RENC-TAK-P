...
import { profilKaydet } from '../../lib/almanca/ilerleme'
import { BECERILER } from '../../lib/almanca/seviyeler'
import { YOGUNLUKLAR } from '../../lib/almanca/yolHaritasi'
...
const ADIMLAR = [
  {
    anahtar: 'amac',
    soru: 'Almancayı ne için öğreniyorsun?',
    ...
    secenekler: [
      ...
      { deger: 'konusma', ad: 'Konuşabilmek', not: 'Dinleme, telaffuz ve Almanca düşünme ağırlıklı' },
      { deger: 'seyahat', ad: 'Seyahat ve günlük hayat', not: 'Kalıplar, durumlar, dinleme' },
      { deger: 'akademik', ad: 'Akademik Almanca', not: 'Okuma, yazma ve akademik kelime' },
      { deger: 'meslek', ad: 'İş hayatı', not: 'Yazışma, sunum, mesleki kelime' },
    ],
  },
  {
    anahtar: 'oncekiDeneyim',
    soru: 'Daha önce Almanca öğrendin mi?',
...
export default function Baslangic() {
  ...
  const bitir = () => {
    ...
    yonlendir('/almanca/seviye-tespit')
  }

  return (
    <AppShell title="Almanca" subtitle="Önce seni tanıyalım" width="narrow">
      <div>
