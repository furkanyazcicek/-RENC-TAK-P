 ...
 * yazma, telaffuz farkındalığı ve İngilizce düşünme (Türkçeden birebir
 * çeviri eğilimi).
 *
 ...
 * Dinleme, cihazda İngilizce ses yoksa hiç sorulmaz ve ölçülmemiş sayılır.
 *
 ...
 * okuma, dinleme, dizim ve İngilizce düşünme de yer bulur.
 *
 * @param {Object} oturum
...
export function sonucla(oturum, profil = null, secenek = {}) {
  ...
  BECERI_ANAHTARLARI.forEach((beceri) => {
    ...
    if (beceri === 'dinleme' && !dinlemeOlculdu) {
      olculemeyenler.push({
        beceri,
        sebep: 'Cihazında İngilizce ses bulunamadığı için dinleme soruları sorulmadı.',
        nasil: 'Cihaz ayarlarından bir İngilizce ses indirdikten sonra dinleme çalışmalarına girebilirsin.',
      })
      return
    }
