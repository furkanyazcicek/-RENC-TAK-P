...
export const BECERILER = {
  ...
  dusunme: { ad: 'Fransızca düşünme', kisa: 'Fransızca düşünme' },
}
...
export const SEVIYELER = {
  'Pre-A1': {
    ...
    ozet: 'Harfleri, sesleri ve ilk kalıpları tanıyorsun. Fransızcayla ilk teması burada kuruyorsun.',
    renk: 'aqua',
    ...
    anlayabilir: [
      ...
      'Sınıfta ya da uygulamada geçen "Écoute", "Répète", "Ouvre ton livre", "Regarde" gibi yönergeleri tanırsın.',
    ],
    konusabilir: [
      'Adını, yaşını ve nereli olduğunu söylersin.',
      'Selamlaşır, teşekkür eder, veda edersin.',
      'Anlamadığında "Pardon ?", "Je ne comprends pas." ya da "Répétez, s\'il vous plaît." diyerek kendini kurtarırsın.',
    ],
    okuyabilir: [
      'Tabela, isim etiketi, sayı ve çok kısa tanışma cümlelerini okursun.',
    ],
    yazabilir: [
      'Kendini tanıtan 3–4 kısa cümle yazarsın: "Je m\'appelle… J\'ai … ans. Je viens de…"',
    ],
    gecisKosulu: [
      'Kendini yardımsız tanıtabilmek',
      '0–100 arası sayıları duyunca tanıyabilmek',
      'Fransızca alfabeyle adını harf harf söyleyebilmek',
      'Basit "être" cümlelerinde özneyi düşürmemek — Fransızcada özne zorunludur (Je suis…, "Suis…" değil)',
    ],
  },
  ...
  A1: {
    ...
    gecisKosulu: [
      'Présent ile günlük rutinini anlatabilmek; -er fiillerini altı kişide de çekebilmek',
      'Soru sormanın üç yolunu (tonlama · est-ce que · devrik) kullanabilmek ve olumsuzu ne … pas ile iki parçalı kurabilmek',
      'le/la ve un/une ayrımını temel kelimelerde yapabilmek; sıfatı ismin cinsine ve sayısına uydurabilmek',
  ...
  A2: {
    ...
    gecisKosulu: [
      'Passé composé kurabilmek ve yardımcı fiilde avoir/être seçimini doğru yapabilmek',
      'COD (le/la/les) ve COI (lui/leur) zamirlerini ayırt edip fiilin ÖNÜNE koyabilmek',
  ...
  B1: {
    ...
    gecisKosulu: [
      'Passé composé ile imparfait arasındaki farkı bağlamda seçebilmek (olay mı, betimleme mi)',
      'Koşul cümlelerinin ilk iki tipini kurabilmek (si + présent → futur · si + imparfait → conditionnel)',
  ...
  B2: {
    ...
    ozet: 'Soyut konuları da takip eder, tartışmaya girer ve düşünceni Fransızca kurarsın.',
    renk: 'info',
    ...
    konusabilir: [
      'Anadili Fransızca olan biriyle iki taraf da zorlanmadan akıcı bir sohbet kurarsın.',
    ...
    gecisKosulu: [
      'Edilgen yapıyı, dolaylı anlatımı ve subjonctif\'i doğal biçimde kullanabilmek',
  ...
  C1: {
    ...
    gecisKosulu: [
      ...
      'Fransızca düşünüp düzenleme yapabilmek — önce Türkçe kurup çevirmemek',
    ],
  },
