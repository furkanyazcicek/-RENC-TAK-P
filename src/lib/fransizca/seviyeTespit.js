 ...
 * yazma, telaffuz farkındalığı ve Fransızca düşünme (Türkçeden birebir
 * çeviri eğilimi).
 *
 ...
 * Dinleme, cihazda Fransızca ses yoksa hiç sorulmaz ve ölçülmemiş sayılır.
 *
 ...
 * okuma, dinleme, dizim ve Fransızca düşünme de yer bulur.
 *
 * @param {Object} oturum
...
export function sonucla(oturum, profil = null, secenek = {}) {
  ...
  BECERI_ANAHTARLARI.forEach((beceri) => {
    ...
    if (beceri === 'dinleme' && !dinlemeOlculdu) {
      olculemeyenler.push({
        beceri,
        sebep: 'Cihazında Fransızca ses bulunamadığı için dinleme soruları sorulmadı.',
        nasil: 'Cihaz ayarlarından bir Fransızca ses indirdikten sonra dinleme çalışmalarına girebilirsin.',
      })
      return
    }
