...
export const BECERILER = {
  ...
  dusunme: { ad: 'İspanyolca düşünme', kisa: 'İspanyolca düşünme' },
}
...
export const SEVIYELER = {
  'Pre-A1': {
    ...
    ozet: 'Harfleri, sesleri ve ilk kalıpları tanıyorsun. İspanyolcayla ilk teması burada kuruyorsun.',
    renk: 'aqua',
    ...
    anlayabilir: [
      ...
      'Sınıfta ya da uygulamada geçen "Escucha", "Repite", "Mira", "Abre el libro" gibi yönergeleri tanırsın.',
    ],
    konusabilir: [
      'Adını, yaşını ve nereli olduğunu söylersin.',
      'Selamlaşır, teşekkür eder, veda edersin.',
      'Anlamadığında "¿Perdón?", "No entiendo." ya da "¿Puede repetir, por favor?" diyerek kendini kurtarırsın.',
    ],
    okuyabilir: [
      'Tabela, isim etiketi, sayı ve çok kısa tanışma cümlelerini okursun.',
    ],
    yazabilir: [
      'Kendini tanıtan 3–4 kısa cümle yazarsın: "Me llamo… Tengo … años. Soy de…"',
    ],
    gecisKosulu: [
      'Kendini yardımsız tanıtabilmek',
      '0–100 arası sayıları duyunca tanıyabilmek',
      'İspanyolca alfabeyle adını harf harf söyleyebilmek',
      '"ser" fiilini altı kişide de çekebilmek ve soy / eres / es biçimlerini karıştırmamak',
    ],
  },
  ...
  A1: {
    ...
    gecisKosulu: [
      'Presente ile günlük rutinini anlatabilmek; -ar, -er ve -ir fiillerini altı kişide de çekebilmek',
      'Soruyu ters işaretle (¿) yazabilmek, soru kelimelerini aksanlı yazabilmek ve olumsuzu tek bir no ile kurabilmek',
      'el/la ve un/una ayrımını temel kelimelerde yapabilmek; sıfatı ismin cinsine ve sayısına uydurabilmek',
  ...
  A2: {
    ...
    gecisKosulu: [
      'Pretérito indefinido ile geçmişi anlatabilmek ve en sık düzensiz biçimleri (fui, hice, tuve) tanımak',
      'Nesne zamirlerini (lo/la/los/las · le/les) ayırt edip fiilin önüne koyabilmek',
  ...
  B1: {
    ...
    gecisKosulu: [
      'Indefinido ile imperfecto arasındaki farkı bağlamda seçebilmek (olay mı, betimleme mi)',
      'Koşul cümlelerinin ilk iki tipini kurabilmek (si + presente → futuro · si + imperfecto de subjuntivo → condicional)',
  ...
  B2: {
    ...
    ozet: 'Soyut konuları da takip eder, tartışmaya girer ve düşünceni İspanyolca kurarsın.',
    renk: 'info',
    ...
    konusabilir: [
      'Anadili İspanyolca olan biriyle iki taraf da zorlanmadan akıcı bir sohbet kurarsın.',
    ...
    gecisKosulu: [
      'Subjuntivo, edilgen yapı ve dolaylı anlatımı doğal biçimde kullanabilmek',
  ...
  C1: {
    ...
    gecisKosulu: [
      ...
      'İspanyolca düşünüp düzenleme yapabilmek — önce Türkçe kurup çevirmemek',
    ],
  },
