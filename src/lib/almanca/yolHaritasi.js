...
export const GOREV_TURLERI = {
  tekrar: { ad: 'Kelime tekrarı', rota: '/almanca/tekrar' },
  ders: { ad: 'Ders', rota: '/almanca/ders' },
  destek: { ad: 'Destek çalışması', rota: '/almanca/ders' },
  dusunme: { ad: 'Almanca düşünme', rota: '/almanca/dusunme' },
  telaffuz: { ad: 'Telaffuz', rota: '/almanca/telaffuz' },
  degerlendirme: { ad: 'Seviye sonu değerlendirme', rota: '/almanca/kutuphane' },
}
...
export function sonrakiDers(ilerleme, dersler) {
  ...
  /* Gelen liste zaten müfredat sırasındadır (bkz. content/almanca/index.js).
  ...
  if (zayif && dakika < yogunluk.gunlukDakika) {
    ...
    if (zayif === 'telaffuz') {
      ...
      ekle({
        id: 'dusunme-destek',
        tur: 'dusunme',
        baslik: 'Almanca düşünme antrenmanı',
