 ...
 * yazma, telaffuz farkındalığı ve Almanca düşünme (Türkçeden birebir
 * çeviri eğilimi).
 *
 ...
 * Dinleme, cihazda Almanca ses yoksa hiç sorulmaz ve ölçülmemiş sayılır.
 *
 ...
 * okuma, dinleme, dizim ve Almanca düşünme de yer bulur.
 *
 * @param {Object} oturum
...
export function sonucla(oturum, profil = null, secenek = {}) {
  ...
  BECERI_ANAHTARLARI.forEach((beceri) => {
    ...
    if (beceri === 'dinleme' && !dinlemeOlculdu) {
      olculemeyenler.push({
        beceri,
        sebep: 'Cihazında Almanca ses bulunamadığı için dinleme soruları sorulmadı.',
        nasil: 'Cihaz ayarlarından bir Almanca ses indirdikten sonra dinleme çalışmalarına girebilirsin.',
      })
      return
    }
