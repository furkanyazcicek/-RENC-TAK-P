...
export const BECERILER = {
  ...
  dusunme: { ad: 'Almanca düşünme', kisa: 'Almanca düşünme' },
}
...
export const SEVIYELER = {
  'Pre-A1': {
    ...
    ozet: 'Harfleri, sesleri ve ilk kalıpları tanıyorsun. Almancayla ilk teması burada kuruyorsun.',
    renk: 'aqua',
    ...
    anlayabilir: [
      ...
      'Sınıfta ya da uygulamada geçen "Hör zu", "Sprich nach", "Öffne dein Buch" gibi yönergeleri tanırsın.',
    ],
    konusabilir: [
      'Adını, yaşını ve nereli olduğunu söylersin.',
      'Selamlaşır, teşekkür eder, veda edersin.',
      'Anlamadığında "Wie bitte?" ya da "Ich verstehe nicht." diyerek kendini kurtarırsın.',
    ],
    okuyabilir: [
      'Tabela, isim etiketi, sayı ve çok kısa tanışma cümlelerini okursun.',
    ],
    yazabilir: [
      'Kendini tanıtan 3–4 kısa cümle yazarsın: "Ich heiße… Ich bin… Ich komme aus…"',
    ],
    gecisKosulu: [
      'Kendini yardımsız tanıtabilmek',
      '0–100 arası sayıları duyunca tanıyabilmek',
      'Almanca alfabeyle adını harf harf söyleyebilmek',
      'Basit "sein" cümlelerinde özneyi düşürmemek (Ich bin…, nicht Bin…)',
    ],
  },
  ...
  A1: {
    ...
    gecisKosulu: [
      'Präsens ile günlük rutinini anlatabilmek ve fiili kişiye göre çekebilmek',
      'Soru cümlesinde fiili başa almak, olumsuzda nicht ile kein ayrımını yapabilmek',
      'der/die/das ve ein/eine ayrımını temel kelimelerde yapabilmek',
  ...
  A2: {
    ...
    gecisKosulu: [
      'Perfekt kurabilmek ve haben/sein seçimini doğru yapabilmek',
      'Akkusativ ve Dativ hâllerini sık kullanılan fiillerle ayırt edebilmek',
  ...
  B1: {
    ...
    gecisKosulu: [
      'Perfekt ile Präteritum arasındaki kullanım farkını bağlamda seçebilmek',
  ...
  B2: {
    ...
    ozet: 'Soyut konuları da takip eder, tartışmaya girer ve düşünceni Almanca kurarsın.',
    renk: 'info',
    ...
    konusabilir: [
      'Anadili Almanca olan biriyle iki taraf da zorlanmadan akıcı bir sohbet kurarsın.',
  ...
  C1: {
    ...
    gecisKosulu: [
      ...
      'Almanca düşünüp düzenleme yapabilmek — önce Türkçe kurup çevirmemek',
    ],
  },
