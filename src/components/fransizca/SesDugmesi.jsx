...
import { seslendir, sesiDurdur } from '../../lib/fransizca/ses'

/**
 * SesDugmesi — bir Fransızca metni cihazın sesiyle okutur.
 *
 * DÜRÜSTLÜK: cihazda Fransızca ses yoksa bu düğme HİÇ görünmez
...
/**
 * SesUyarisi — cihazda Fransızca ses bulunamadığında gösterilen açıklama.
...
export function SesUyarisi({ durum, className }) {
  ...
  return (
    <div
      ...
      role="status"
    >
      <p className="font-semibold text-ink">Bu cihazda Fransızca ses yok</p>
