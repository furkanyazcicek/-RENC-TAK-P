...
import { seslendir, sesiDurdur } from '../../lib/ingilizce/ses'

/**
 * SesDugmesi — bir İngilizce metni cihazın sesiyle okutur.
 *
 * DÜRÜSTLÜK: cihazda İngilizce ses yoksa bu düğme HİÇ görünmez
...
/**
 * SesUyarisi — cihazda İngilizce ses bulunamadığında gösterilen açıklama.
...
export function SesUyarisi({ durum, className }) {
  ...
  return (
    <div
      ...
      role="status"
    >
      <p className="font-semibold text-ink">Bu cihazda İngilizce ses yok</p>
