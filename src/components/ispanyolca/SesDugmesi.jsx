...
import { seslendir, sesiDurdur } from '../../lib/ispanyolca/ses'

/**
 * SesDugmesi — bir İspanyolca metni cihazın sesiyle okutur.
 *
 * DÜRÜSTLÜK: cihazda İspanyolca ses yoksa bu düğme HİÇ görünmez
...
/**
 * SesUyarisi — cihazda İspanyolca ses bulunamadığında gösterilen açıklama.
...
export function SesUyarisi({ durum, className }) {
  ...
  return (
    <div
      ...
      role="status"
    >
      <p className="font-semibold text-ink">Bu cihazda İspanyolca ses yok</p>
