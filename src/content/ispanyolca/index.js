/**
 * DRKOÇ — İSPANYOLCA İÇERİĞİ KAYIT DEFTERİ
 * ==================================================================
 *
 ...
 *
 * Bu ağaç, İngilizce, Almanca ve Fransızca bölümleriyle AYNI sözleşmeyi
 * (bkz. lib/ispanyolca/sema.js) kullanır ama kendi içeriği, kendi
 * seslendirmesi ve kendi ilerleme kaydı vardır. Bölümler birbirinden
 * tamamen bağımsızdır: İspanyolca içeriğindeki bir hata diğerlerini
 * etkilemez.
 */
