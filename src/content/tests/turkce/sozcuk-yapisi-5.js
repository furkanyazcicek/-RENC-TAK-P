export default [
  {
    id: 'test-sozcuk-yapisi-5-kolay',
    title: 'Sözcük Yapısı 5 (Kolay)',
    description: 'Sözcük Yapısı (Ekler ve Kökler) - Kolay (41-50)',
    type: 'comprehension',
    order: 13,
    questions: [
      {
        id: 'q-sy-5-1',
        difficulty: 'easy',
        questionText: 'Kelimelerin anlamlı en küçük yapı birimine kök denir. Türkçe kökler isim ve fiil olmak üzere iki ana gruba ayrılır. Aşağıdaki altı çizili kelimelerin hangisinin kökü tür bakımından diğerlerinden farklıdır?',
        options: [
          { id: 'A', text: 'Bahçedeki kocaman *ağaç* devrilmiş.' },
          { id: 'B', text: 'Elindeki ağır *taşı* zorlukla kaldırdı.' },
          { id: 'C', text: 'Dünkü sınavda bazı *sorular* zordu.' },
          { id: 'D', text: 'Sabah erkenden bütün evi *temizledi*.' },
          { id: 'E', text: 'Dolaptaki soğuk *suyu* bir dikişte içti.' }
        ],
        correctOptionId: 'C',
        explanation: 'Ağaç, taş, temiz (temiz-le-di kelimesinin kökü "temiz" ismidir) ve su kelimelerinin kökleri isimdir. "Sorular" kelimesinin kökü "sor-" ise fiil köküdür (sor-mak).'
      },
      {
        id: 'q-sy-5-2',
        difficulty: 'easy',
        questionText: 'Aşağıdaki altı çizili sözcüklerden hangisi yapım eki almıştır (türemiştir)?',
        options: [
          { id: 'A', text: 'Arkadaşının yeni aldığı *arabası* çok güzel.' },
          { id: 'B', text: 'Evdeki *eşyaları* teker teker dışarı çıkardı.' },
          { id: 'C', text: 'Sokaktaki *simitçi* bağırarak uzaklaştı.' },
          { id: 'D', text: 'Bütün *kitaplarını* çantasına yerleştirdi.' },
          { id: 'E', text: 'Bugün *okula* yürüyerek gitmek istedi.' }
        ],
        correctOptionId: 'C',
        explanation: '"Simitçi" kelimesi isim kökü olan "simit" kelimesine "-çi" yapım eki getirilerek türetilmiştir. Diğer kelimeler sadece çekim ekleri almıştır (araba-sı, eşya-lar-ı, kitap-lar-ı-n-ı, okul-a).'
      },
      {
        id: 'q-sy-5-3',
        difficulty: 'easy',
  ...
  {
    id: 'test-sozcuk-yapisi-5-orta',
    title: 'Sözcük Yapısı 5 (Orta)',
    description: 'Sözcük Yapısı (Ekler ve Kökler) - Orta (41-50)',
    type: 'comprehension',
    order: 14,
    questions: [
      {
      ...
      },
      {
        id: 'q-sy-5-12',
        difficulty: 'medium',
        questionText: 'Kök + yapım eki + yapım eki şeklinde oluşan kelimeler "gövdeden türemiş" sayılır. Aşağıdaki altı çizili kelimelerden hangisi gövdeden türemiştir?',
        options: [
          { id: 'A', text: 'Bütün *kitapları* kutulara dizdi.' },
          { id: 'B', text: 'O, okulun en iyi *gözlemcisi* seçildi.' },
          { id: 'C', text: 'Yeni açılan *çiçekçi* çok ilgi gördü.' },
          { id: 'D', text: 'Havalar ısınınca her taraf *yeşerdi*.' },
          { id: 'E', text: 'O çok *saygılı* bir öğrencidir.' }
        ],
        correctOptionId: 'B',
        explanation: '"Gözlemcisi" kelimesinin kökü göz (isim). Göz-le (isimden fiil) -> gözle-m (fiilden isim) -> gözlem-ci (isimden isim). Üç yapım eki almıştır ve gövdeden türemiştir. (Saygılı kelimesinde say-gı-lı, 2 yapım eki vardır, bu da gövdeden türemiştir. Şıkkı "bilgin" ile değiştirelim. A) Kitapları B) Gözlemcisi C) Çiçekçi D) Yeşerdi E) Bilgin. Doğru cevap B).'
      },
      {
        id: 'q-sy-5-12-revised',
        difficulty: 'medium',
  ...
  {
    id: 'test-sozcuk-yapisi-5-zor',
    title: 'Sözcük Yapısı 5 (Zor)',
    description: 'Sözcük Yapısı (Ekler ve Kökler) - Zor (41-50)',
    type: 'comprehension',
    order: 15,
    questions: [
      {
