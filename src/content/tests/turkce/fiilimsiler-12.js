export default [
  {
    id: 'test-fiilimsiler-12-kolay',
    title: 'Fiilimsiler 12 (Kolay)',
    description: 'Fiilimsiler - Kolay (111-120)',
    type: 'comprehension',
    order: 34,
    questions: [
      {
        ...
        options: [
          { id: 'A', text: 'Koşan çocuk bir anda düştü.' },
          { id: 'B', text: 'Seninle görüşmeyi çok istedim.' },
          { id: 'C', text: 'Bugün hava çok güzeldi.' },
          { id: 'D', text: 'Beni aradığında saat geçti.' },
          { id: 'E', text: 'Görünmez kaza canından ediyordu.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğinde isim ("hava") ve sıfat ("güzeldi") kullanılmıştır, fiilimsi yoktur. A\'da "Koşan", B\'de "görüşmeyi", D\'de "aradığında", E\'de "Görünmez" eylemsidir.'
      },
      {
        id: 'q-fsi-12-2',
        difficulty: 'easy',
  ...
  {
    id: 'test-fiilimsiler-12-orta',
    title: 'Fiilimsiler 12 (Orta)',
    description: 'Fiilimsiler - Orta (111-120)',
    type: 'comprehension',
    order: 35,
    questions: [
      {
  ...
  {
    id: 'test-fiilimsiler-12-zor',
    title: 'Fiilimsiler 12 (Zor)',
    description: 'Fiilimsiler - Zor (111-120)',
    type: 'comprehension',
    order: 36,
    questions: [
      {
