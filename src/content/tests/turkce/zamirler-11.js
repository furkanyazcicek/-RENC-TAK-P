export default [
  {
    id: 'test-zamirler-11-kolay',
    title: 'Zamirler 11 (Kolay)',
    description: 'Zamirler - Kolay (101-110)',
    type: 'comprehension',
    order: 31,
    questions: [
      {
        ...
        options: [
          { id: 'A', text: 'Onları buraya dikkatlice yerleştirmelisin.' },
          { id: 'B', text: 'O araba gerçekten çok hızlıydı.' },
          { id: 'C', text: 'Bu ev bize çok küçük geliyor artık.' },
          { id: 'D', text: 'Şu çocuk sana sesleniyor galiba.' },
          { id: 'E', text: 'Öteki yoldan gidersen daha erken ulaşırsın.' }
        ],
        correctOptionId: 'A',
        explanation: 'A seçeneğindeki "Onları" kelimesi eşya veya nesnenin (çiçek, kitap vs.) yerini tuttuğu için işaret zamiridir. Diğer seçeneklerdeki o, bu, şu, öteki kelimeleri ismin önüne gelerek onları işaret ettikleri için işaret sıfatıdır.'
      },
      {
        id: 'q-zm-11-2',
        difficulty: 'easy',
        ...
        options: [
          { id: 'A', text: 'Bana doğruyu söylemediğini artık biliyorum.' },
          { id: 'B', text: 'Benimle gelirsen sana her şeyi anlatırım.' },
          { id: 'C', text: 'Bizden daha şanslı olduklarını düşünüyorlar.' },
          { id: 'D', text: 'Şunları da poşete dikkatlice koyuver.' },
          { id: 'E', text: 'Seninle aynı fikirde olduğumu bilmelisin.' }
        ],
        correctOptionId: 'D',
        explanation: 'D seçeneğindeki "Şunları" kelimesi işaret zamiridir, kişi zamiri değildir. Diğer seçeneklerdeki bana, benimle/sana, bizden, seninle kelimeleri kişi zamiridir.'
      },
      {
        id: 'q-zm-11-3',
        difficulty: 'easy',
        ...
        options: [
          { id: 'A', text: 'Hangi arabayı almayı planlıyorsunuz?' },
          { id: 'B', text: 'Nasıl bir iş aradığını bana söyler misin?' },
          { id: 'C', text: 'Toplantıya neden bu kadar geç kaldın?' },
          { id: 'D', text: 'Bu güzel hediyeyi sana kim aldı?' },
          { id: 'E', text: 'Dışarı çıkarken şemsiyeni aldın mı?' }
        ],
        correctOptionId: 'D',
        explanation: 'D seçeneğindeki "kim" kelimesi soru zamiridir. A\'da hangi (sıfat), B\'de nasıl (sıfat), C\'de neden (zarf), E\'de mı (edat) vardır.'
      },
      {
        id: 'q-zm-11-4',
        difficulty: 'easy',
        ...
        options: [
          ...
          { id: 'B', text: 'Hiçbir insan bu kadar zorluk çekmemeli.' },
          { id: 'C', text: 'Bazı günler evden hiç çıkmak istemem.' },
          { id: 'D', text: 'Bütün sokaklar bayraklarla süslendi.' },
          { id: 'E', text: 'Herkes kendi işini en iyi şekilde yapsın.' }
        ],
        correctOptionId: 'E',
        explanation: 'E seçeneğindeki "Herkes" kelimesi belgisiz zamirdir. Diğer seçeneklerdeki hiçbir, her, bazı, bütün kelimeleri belgisiz sıfattır.'
      },
      {
        id: 'q-zm-11-5',
        difficulty: 'easy',
        ...
        options: [
          ...
          { id: 'B', text: 'Bu yemeği ben kendim senin için hazırladım.' },
          { id: 'C', text: 'Kendini bu kadar yormanın bir anlamı yok.' },
          { id: 'D', text: 'Oraya kendi başına gitmekten çok korkuyor.' },
          { id: 'E', text: 'Kendisine verilen görevi layıkıyla yerine getirdi.' }
        ],
        correctOptionId: 'B',
        explanation: 'B seçeneğinde dönüşlülük zamiri "kendim", özne olan "ben" ile birlikte kullanılarak anlamı pekiştirmiştir.'
      },
      {
        id: 'q-zm-11-6',
        difficulty: 'easy',
        ...
        options: [
          ...
          { id: 'C', text: 'Benim silgim kayboldu, seninkini alabilir miyim?' },
          { id: 'D', text: 'Bugünkü haberler oldukça ilginçti.' },
          { id: 'E', text: 'Yüzündeki tebessüm her şeyi anlatıyordu.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğindeki "seninkini" kelimesinde bulunan "-ki", ismin (silginin) yerini tutan ilgi zamiridir. Diğer seçeneklerdeki -ki ekleri sıfat yapan yapım ekidir.'
      },
      {
        id: 'q-zm-11-7',
        difficulty: 'easy',
        ...
        options: [
          ...
          { id: 'C', text: 'Bu zor günlerde en çok onlar bize destek oldu.' },
          { id: 'D', text: 'Onları vazoya değil, doğrudan bahçeye ek.' },
          { id: 'E', text: 'Onlar bu şirketin en değerli çalışanlarıdır.' }
        ],
        correctOptionId: 'D',
        explanation: 'D seçeneğindeki "Onları" kelimesi bitki veya çiçek gibi insan dışı varlıkların yerini tuttuğu için işaret zamiridir. Diğer seçeneklerde insanları karşıladığı için kişi zamiridir.'
      },
      {
        id: 'q-zm-11-8',
        difficulty: 'easy',
        ...
        options: [
          ...
          { id: 'B', text: 'Şu çocuk sabahtan beri durmadan ağlıyor.' },
          { id: 'C', text: 'Bunu bana neden daha önce söylemedin?' },
          { id: 'D', text: 'Onun bu söylediklerine kimse inanmak istemedi.' },
          { id: 'E', text: 'Oraya gitmek için çok erken kalkmalıyız.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğinde "Bunu" (işaret zamiri) ve "bana" (kişi zamiri) olmak üzere iki farklı zamir bir arada kullanılmıştır.'
      },
      {
        id: 'q-zm-11-9',
        difficulty: 'easy',
        ...
        correctOptionId: 'C',
        explanation: 'C seçeneğindeki "ancak" kelimesi bağlaç veya edattır. Hiçbir zaman ismin yerini tutup zamir olamaz.'
      },
      {
        id: 'q-zm-11-10',
        difficulty: 'easy',
        ...
        options: [
          ...
          { id: 'C', text: 'Bana sormadan hiçbir işe kalkışma.' },
          { id: 'D', text: 'Bize her zaman destek olan kişi sendin.' },
          { id: 'E', text: 'Sana bu konuda sonuna kadar güveniyorum.' }
        ],
        correctOptionId: 'D',
        explanation: 'D seçeneğinde "biz" zamiri -e hal eki almış (bize) ancak kökünde bir ünlü değişimi olmamıştır. Sadece "ben" ve "sen" zamirlerinde (bana, sana) ünlü değişimi olur.'
      }
    ]
  },
  {
    id: 'test-zamirler-11-orta',
    title: 'Zamirler 11 (Orta)',
    description: 'Zamirler - Orta (101-110)',
    type: 'comprehension',
    order: 32,
    questions: [
      {
        ...
        correctOptionId: 'D',
        explanation: 'D seçeneğinde "Onun düşünceleri" isim tamlamasında "Onun" (kişi zamiri) tamlayan görevindedir. Diğer seçeneklerde zamirler (birkaçı, hepsi, hangisi, kimsesi) tamlanan görevindedir.'
      },
      {
        id: 'q-zm-11-12',
        difficulty: 'medium',
        ...
        options: [
          ...
          { id: 'E', text: 'Bana pazardan gelirken ne aldın?' }
        ],
        correctOptionId: 'E',
        explanation: 'E seçeneğinde "ne" kelimesi ismin (meyve, sebze vs.) yerini soru yoluyla tuttuğu için soru zamiridir. A ve D\'de soru zarfı, B ve C\'de ise soru sıfatı olarak kullanılmıştır.'
      },
      {
        id: 'q-zm-11-13',
        difficulty: 'medium',
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'D', text: 'Bugün KALEMİMİ evde unutmuşum.' },
          { id: 'E', text: 'BANA bunu daha önce söylemeliydin.' }
        ],
        correctOptionId: 'D',
        explanation: 'D seçeneğinde "kalem-im-i" sözcüğündeki "-im" eki, ismin kime ait olduğunu bildiren iyelik ekidir (iyelik zamiri). Diğer seçeneklerdeki kelimelerde iyelik eki yoktur.'
      },
      {
        id: 'q-zm-11-15',
        difficulty: 'medium',
        ...
        options: [
          ...
          { id: 'C', text: 'Bizi burada saatlerce bekleten şey trafikti.' },
          { id: 'D', text: 'Dün akşam arayan kişi oydu.' },
          { id: 'E', text: 'Şu an masanın üzerinde duran kitap benimkidir.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğinde yüklem "trafikti" sözcüğüdür ve isimdir. Diğer seçeneklerde sensin, bendim, oydu, benimkidir sözcükleri zamirdir ve yüklem olmuşlardır.'
      },
      {
        id: 'q-zm-11-16',
        difficulty: 'medium',
        ...
        options: [
          ...
          { id: 'D', text: 'Senin arabanı sattık, şimdi onunkiyle idare ediyoruz.' },
          { id: 'E', text: 'Sokaktaki çocukların sesleri buraya kadar geliyor.' }
        ],
        correctOptionId: 'E',
        explanation: 'E seçeneğindeki "Sokaktaki" kelimesinde bulunan "-ki", ismin önüne gelerek onu niteleyen sıfat yapan yapım ekidir. Diğerlerindeki -ki ekleri ismin yerini tutan ilgi zamiridir.'
      },
      {
        id: 'q-zm-11-17',
        difficulty: 'medium',
  ...
  {
    id: 'test-zamirler-11-zor',
    title: 'Zamirler 11 (Zor)',
    description: 'Zamirler - Zor (101-110)',
    type: 'comprehension',
    order: 33,
    questions: [
      {
        ...
        options: [
          ...
          { id: 'B', text: 'Bu ev bizim, diyerek övünüyordu.' },
        ...
        correctOptionId: 'B',
        explanation: 'B seçeneğinde "bizim" sözcüğünün aslı "bizim evimiz" şeklindedir. Tamlanan (evimiz) ve iyelik eki düşmüş, sadece tamlayan eki almış kişi zamiri (biz-im) kalmıştır.'
      },
      {
        id: 'q-zm-11-22',
        difficulty: 'hard',
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'C', text: 'O, masanın üzerindeki kırmızı kitabı aldı.' },
          { id: 'D', text: 'Ben onu hiçbir zaman böyle düşünmemiştim.' },
          { id: 'E', text: 'O karanlık gecede yolumuzu kaybetmiştik.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğinde "O" sözcüğünden sonra virgül getirilerek onun özne (kişi zamiri) olduğu belirtilmiştir. Virgül olmasaydı sıfat sanılabilirdi.'
      },
      {
        id: 'q-zm-11-24',
        difficulty: 'hard',
        ...
        options: [
          ...
          { id: 'E', text: 'Kendilerini çok zeki sanan insanlar yanılırlar.' }
        ],
        correctOptionId: 'E',
        explanation: 'E seçeneğinde "Kendilerini" kelimesi kök olan "kendi"ye -ler (çoğul), -i (iyelik), -n (kaynaştırma), -i (belirtme hal eki) alarak tüm bu ekleri barındırmaktadır.'
      },
      {
        id: 'q-zm-11-25',
        difficulty: 'hard',
        ...
        options: [
          ...
          { id: 'C', text: 'Oluşan benliği kırmak oldukça zordur.' },
          { id: 'D', text: 'Kimsesiz çocuklara yardım eli uzatmalıyız.' },
          { id: 'E', text: 'Onun bu bencilce tavırları herkesi bıktırdı.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğinde "benlik" kelimesi isimdir. Diğer seçeneklerdeki bencil, sensiz, kimsesiz, bencilce sözcükleri sıfattır.'
      },
      {
        id: 'q-zm-11-26',
        difficulty: 'hard',
        ...
        options: [
          ...
          { id: 'C', text: 'Kimi kimsesi kalmamış yaşlı bir adamdı.' },
          { id: 'D', text: 'Bazı bazı eski günleri hatırlayıp hüzünleniyorum.' },
          { id: 'E', text: 'Tek tük insanlar geçiyordu ıssız sokaktan.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğindeki "Kimi kimsesi" ikilemesi, "kim" ve "kimse" belgisiz zamirlerinin bir araya gelmesiyle oluşmuştur.'
      },
      {
        id: 'q-zm-11-27',
        difficulty: 'hard',
        ...
        options: [
          ...
          { id: 'D', text: 'Kendinden geçmiş bir halde sokakta yatıyordu.' },
          { id: 'E', text: 'Kendime yeni bir bilgisayar almayı düşünüyorum.' }
        ],
        correctOptionId: 'D',
        explanation: 'D seçeneğinde "kendinden geçmek" deyimi içinde yer alan "kendi" sözcüğü, ayrılma hal eki alarak şuurunu kaybetmek anlamında mecazlaşmıştır.'
      },
      {
        id: 'q-zm-11-28',
        difficulty: 'hard',
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'D', text: 'Bazıları bu durumu kendi lehine çevirdi.' },
          { id: 'E', text: 'Birtakımı oylamaya katılmaktan vazgeçti.' }
        ],
        correctOptionId: 'D',
        explanation: 'D seçeneğindeki "Bazıları" kelimesi basit/çekimli kabul edilir ancak birleşik değildir. Diğer seçeneklerdeki hiçkimse, birkaçı, birçoğu, birtakımı kelimeleri birleşiktir.'
      }
    ]
  }
];
