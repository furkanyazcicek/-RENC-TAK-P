export default [
  {
    id: 'test-fiilimsiler-14-kolay',
    title: 'Fiilimsiler 14 (Kolay)',
    description: 'Fiilimsiler - Kolay (131-140)',
    type: 'comprehension',
    order: 40,
    questions: [
      {
        ...
        options: [
          { id: 'A', text: 'Koşarak yanımızdan uzaklaştı.' },
          { id: 'B', text: 'Kitap okumayı çok seviyor.' },
          { id: 'C', text: 'Bugün hava gerçekten çok soğuktu.' },
          { id: 'D', text: 'Biten bir günün ardından uykuya daldı.' },
          { id: 'E', text: 'Beni aradığında saat çok erkendi.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğinde fiilimsi yoktur. "Hava" ve "soğuktu" kelimeleri isim soyludur. Diğerlerinde koşarak, okumayı, biten, aradığında eylemsidir.'
      },
      {
        id: 'q-fsi-14-2',
        difficulty: 'easy',
        questionText: '"Gelecek hafta yeni bir projeye başlıyor." cümlesindeki "gelecek" kelimesinin türü nedir?',
        options: [
          { id: 'A', text: 'Çekimli fiil' },
        ...
        correctOptionId: 'B',
        explanation: '"Gelecek" kelimesi "hafta" ismini niteleyen bir sıfat-fiildir (-ecek eki almıştır).'
      },
      {
        id: 'q-fsi-14-3',
        difficulty: 'easy',
      ...
      },
      {
        ...
        options: [
          { id: 'A', text: 'Sokakta bir uçurtma bulduk.' },
        ...
        correctOptionId: 'A',
        explanation: 'A seçeneğindeki "uçurtma" kelimesi bir oyuncağın adı olmuş, eylem anlamını yitirip kalıcı isim olmuştur.'
      },
      {
        id: 'q-fsi-14-5',
        difficulty: 'easy',
        questionText: 'Aşağıdaki cümlelerin hangisinde zarf-fiil cümleye durum (tarz) anlamı katmıştır?',
        options: [
      ...
      },
      {
        ...
        correctOptionId: 'D',
        explanation: 'D seçeneğinde "Bilenler" ve "bilmeyenlere" kelimeleri niteledikleri isimler düştüğü için adlaşmış sıfat-fiillerdir.'
      },
      {
        id: 'q-fsi-14-10',
        difficulty: 'easy',
  ...
  {
    id: 'test-fiilimsiler-14-orta',
    title: 'Fiilimsiler 14 (Orta)',
    description: 'Fiilimsiler - Orta (131-140)',
    type: 'comprehension',
    order: 41,
    questions: [
      {
  ...
  {
    id: 'test-fiilimsiler-14-zor',
    title: 'Fiilimsiler 14 (Zor)',
    description: 'Fiilimsiler - Zor (131-140)',
    type: 'comprehension',
    order: 42,
    questions: [
      {
