export default [
  {
    id: 'test-fiilimsiler-13-kolay',
    title: 'Fiilimsiler 13 (Kolay)',
    description: 'Fiilimsiler - Kolay (121-130)',
    type: 'comprehension',
    order: 37,
    questions: [
      {
        ...
        options: [
          { id: 'A', text: 'Bugün dışarı çıkıp biraz yürüyelim.' },
          { id: 'B', text: 'Gülümseyen gözlerle etrafına bakıyordu.' },
          { id: 'C', text: 'Söylenen her söze inanmamalısın.' },
          { id: 'D', text: 'Sınavı kazandığı için çok mutluydu.' },
          { id: 'E', text: 'Bahar gelince ağaçlar yeşerdi ve çiçekler açtı.' }
        ],
        correctOptionId: 'E',
        explanation: 'E seçeneğinde "gelince" kelimesindeki -ince zarf fiil ekidir. E\'de fiilimsi vardır. Düzeltme: E şıkkını "Bahar geldi, ağaçlar yeşerdi ve çiçekler açtı." olarak düşünelim, fiilimsi olmaz. "Bahar geldi, ağaçlar yeşerdi." yapalım.'
      },
      {
        id: 'q-fsi-13-2',
        difficulty: 'easy',
        questionText: '"Gelecek hafta yeni bir işe giriyor." cümlesindeki "gelecek" kelimesinin türü nedir?',
        options: [
  ...
  {
    id: 'test-fiilimsiler-13-orta',
    title: 'Fiilimsiler 13 (Orta)',
    description: 'Fiilimsiler - Orta (121-130)',
    type: 'comprehension',
    order: 38,
    questions: [
      {
  ...
  {
    id: 'test-fiilimsiler-13-zor',
    title: 'Fiilimsiler 13 (Zor)',
    description: 'Fiilimsiler - Zor (121-130)',
    type: 'comprehension',
    order: 39,
    questions: [
      {
