export default [
  {
    id: 'test-ebu-11-kolay',
    title: 'Edat Bağlaç Ünlem 11 (Kolay)',
    description: 'Edat Bağlaç Ünlem - Kolay (101-110)',
    type: 'comprehension',
    order: 31,
    questions: [
      {
        ...
        options: [
          { id: 'A', text: 'Dağ gibi adam birden çöktü.' },
          { id: 'B', text: 'Onu gördüğüm gibi hemen tanıdım.' },
          { id: 'C', text: 'Sabaha kadar hiç uyumadan çalıştık.' },
          { id: 'D', text: 'Çay ve kahve ikramı yapıldı.' },
          { id: 'E', text: 'Evden çıkabildik lakin otobüsü kaçırdık.' }
        ],
        correctOptionId: 'D',
        explanation: 'D seçeneğinde "ve" kelimesi, "çay" ile "kahve" sözcüklerini birbirine bağlayan bir bağlaçtır.'
      },
      {
        id: 'q-ebu-11-2',
        difficulty: 'easy',
        ...
        options: [
          ...
          { id: 'C', text: 'Ah, elimi kestim!' },
          { id: 'D', text: 'Kitabını masada unutmuş.' },
          { id: 'E', text: 'Oraya gitmeyi çok istiyordu.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğindeki "Ah" kelimesi acı bildiren bir ünlemdir.'
      },
      {
        id: 'q-ebu-11-3',
        difficulty: 'easy',
        questionText: 'Aşağıdaki cümlelerin hangisinde "için" edatı cümleye amaç anlamı katmıştır?',
        options: [
          { id: 'A', text: 'Bu hediyeyi annen için aldık.' },
          { id: 'B', text: 'Kilo vermek için diyet yapıyor.' },
          { id: 'C', text: 'Hastalandığı için okula gidemedi.' },
          { id: 'D', text: 'Onun için çok çalışkan diyorlar.' },
          { id: 'E', text: 'Senin için her şeyi yaparım.' }
        ],
        correctOptionId: 'B',
        explanation: 'B seçeneğinde eylemin yapılış amacı ("kilo vermek maksadıyla") belirtilmiştir.'
      },
      {
        id: 'q-ebu-11-4',
        difficulty: 'easy',
        questionText: 'Aşağıdaki altı çizili sözcüklerden hangisi bağlaç değildir?',
        options: [
          { id: 'A', text: 'Hem okuyor *hem* çalışıyor.' },
          { id: 'B', text: 'Bana *göre* bu işin sonu iyi değil.' },
          { id: 'C', text: 'Ne aradı *ne* sordu.' },
          { id: 'D', text: 'Çok çalıştı *ama* kazanamadı.' },
          { id: 'E', text: 'Oraya gittim *fakat* kimseyi bulamadım.' }
        ],
        correctOptionId: 'B',
        explanation: 'B seçeneğindeki "göre" sözcüğü edattır, bağlaç değildir.'
      },
      {
        id: 'q-ebu-11-5',
        difficulty: 'easy',
        questionText: '"Kadar" edatı aşağıdaki cümlelerin hangisinde zaman anlamı katmıştır?',
        options: [
          { id: 'A', text: 'Akşama kadar hiç durmadan yağdı.' },
          { id: 'B', text: 'Avuç içi kadar bir odada kalıyor.' },
          { id: 'C', text: 'O da ablası kadar boylu poslu olmuş.' },
          { id: 'D', text: 'Evden okula kadar yürüdük.' },
          { id: 'E', text: 'İki ton kadar kömür aldık.' }
        ],
        correctOptionId: 'A',
        explanation: 'A seçeneğinde "akşama kadar" ifadesi eylemin süresini, zamanını bildirmektedir.'
      },
      {
        id: 'q-ebu-11-6',
        difficulty: 'easy',
        ...
        options: [
          { id: 'A', text: 'Dünkü maç çok heyecanlıydı.' },
          { id: 'B', text: 'Evdeki hesap çarşıya uymadı.' },
          { id: 'C', text: 'Öyle yorgunum ki hemen uyuyacağım.' },
          { id: 'D', text: 'Yüzündeki tebessüm hiç solmasın.' },
          { id: 'E', text: 'Seninki yine ortalarda görünmüyor.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğinde "ki" sözcüğü ayrı yazılmıştır ve iki yargıyı bağlayan bir bağlaçtır.'
      },
      {
        id: 'q-ebu-11-7',
        difficulty: 'easy',
        ...
        options: [
          { id: 'A', text: 'Kitabım evde kalmış.' },
          { id: 'B', text: 'Sokakta oynayan çocukları izledi.' },
          { id: 'C', text: 'Bunu sen de biliyorsun.' },
          { id: 'D', text: 'Masada duran vazoyu kırdı.' },
          { id: 'E', text: 'Yolda yürürken ayağı takıldı.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğinde "de" sözcüğü ayrı yazılmış ve "dahi, bile" anlamı katan bir bağlaç olarak kullanılmıştır.'
      },
      {
        id: 'q-ebu-11-8',
        difficulty: 'easy',
        questionText: '"İle" sözcüğü aşağıdakilerin hangisinde edat görevindedir?',
        options: [
          { id: 'A', text: 'Leyla ile Mecnun hikayesi meşhurdur.' },
          { id: 'B', text: 'Romanla hikaye okumayı sever.' },
          { id: 'C', text: 'Bıçak ile meyveyi soydu.' },
          { id: 'D', text: 'Kalemle kağıt masanın üzerindeydi.' },
          { id: 'E', text: 'Ahmet ile Mehmet yarın bize gelecek.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğinde "ile" araç bildirir, "ve" anlamına gelmez. Bu yüzden edattır.'
      },
      {
        id: 'q-ebu-11-9',
        difficulty: 'easy',
        questionText: 'Aşağıdaki ünlemlerden hangisi seslenme, dikkati çekme bildirmektedir?',
        options: [
          { id: 'A', text: 'Aman, ne hali varsa görsün!' },
          { id: 'B', text: 'Tüh, yine kaçırdık otobüsü.' },
          { id: 'C', text: 'Vah vah, adama çok yazık oldu.' },
          { id: 'D', text: 'Hey, oradaki adam buraya bak!' },
          { id: 'E', text: 'Oh, sonunda iş bitti.' }
        ],
        correctOptionId: 'D',
        explanation: 'D seçeneğindeki "Hey" ünlemi karşıdakinin dikkatini çekmek ve seslenmek amacıyla kullanılmıştır.'
      },
      {
        id: 'q-ebu-11-10',
        difficulty: 'easy',
        ...
        options: [
          { id: 'A', text: 'Geldi ve gitti.' },
          { id: 'B', text: 'Sabahtan beri onu bekliyorum.' },
          { id: 'C', text: 'Kitabı aldı ancak okumadı.' },
          { id: 'D', text: 'Çok çalıştı fakat kazanamadı.' },
          { id: 'E', text: 'Oraya gittim lakin onu bulamadım.' }
        ],
        correctOptionId: 'B',
        explanation: 'B seçeneğindeki "beri" sözcüğü (-den beri) edattır, cümlede bağlaç yoktur.'
      }
    ]
  },
  {
    id: 'test-ebu-11-orta',
    title: 'Edat Bağlaç Ünlem 11 (Orta)',
    description: 'Edat Bağlaç Ünlem - Orta (101-110)',
    type: 'comprehension',
    order: 32,
    questions: [
      {
        ...
        options: [
          { id: 'A', text: 'Bana bir bardak su verir misin?' },
          { id: 'B', text: 'Bir gün mutlaka seninle karşılaşacağız.' },
          { id: 'C', text: 'Bu işten bir sen anlarsın.' },
          { id: 'D', text: 'Elimdeki bir deste gülü ona verdim.' },
          { id: 'E', text: 'İkimiz bir boydayız.' }
        ],
        correctOptionId: 'C',
        explanation: '"Bir" sözcüğü "sadece, tek" anlamında kullanıldığında edattır. C seçeneğinde "sadece sen anlarsın" anlamındadır.'
      },
      {
        id: 'q-ebu-11-12',
        difficulty: 'medium',
        ...
        options: [
          { id: 'A', text: 'Ne kitap okuyor ne televizyon izliyor.' },
          { id: 'B', text: 'Akşama doğru eve döndüler.' },
          { id: 'C', text: 'Oraya gittim fakat onu bulamadım.' },
          { id: 'D', text: 'Bugün ya sinemaya gidelim ya da tiyatroya.' },
          { id: 'E', text: 'Çok çalıştı ama kazanamadı.' }
        ],
        correctOptionId: 'B',
        explanation: 'B seçeneğinde "-e doğru" (akşama doğru) şeklinde zaman bildiren bir edat kullanılmıştır. Diğer seçeneklerde bağlaçlar vardır.'
      },
      {
        id: 'q-ebu-11-13',
        difficulty: 'medium',
        ...
        options: [
          ...
          { id: 'B', text: 'Bunca kalabalığın içinde yine yalnızdı.' },
          { id: 'C', text: 'Yalnız insanların hayatı daha zordur.' },
          { id: 'D', text: 'Bu problemi yalnız Ali çözebilir.' },
      ...
      },
      {
        ...
        options: [
          { id: 'A', text: 'Bahar geldi mi her taraf yeşillenir.' },
        ...
        correctOptionId: 'A',
        explanation: 'A seçeneğinde "mi" edatı "geldiği zaman, gelince" anlamı katarak zaman/koşul ilgisi kurmuştur.'
      },
      {
        id: 'q-ebu-11-15',
        difficulty: 'medium',
        ...
        options: [
          ...
          { id: 'D', text: 'Kapıyı büyük bir hızla açtı.' },
          { id: 'E', text: 'Kalemle kağıt masanın üzerindeydi.' }
        ],
        correctOptionId: 'D',
        explanation: 'D seçeneğinde "büyük bir hızla" ifadesi eylemin (açtı) nasıl yapıldığını yani durumunu bildiren bir zarf öbeği oluşturmuştur.'
      },
      {
        id: 'q-ebu-11-16',
        difficulty: 'medium',
        ...
        options: [
          ...
          { id: 'B', text: 'Aman! ne hali varsa görsün.' },
          { id: 'C', text: 'Eyvah! Anahtarımı içeride unuttum.' },
          { id: 'D', text: 'Hey! Buraya bakar mısınız?' },
          { id: 'E', text: 'Tüh! Otobüsü yine kaçırdım.' }
        ],
        correctOptionId: 'B',
        explanation: 'Ünlem işaretinden (!) sonra başlayan cümle büyük harfle başlamalıdır. B seçeneğinde "ne" kelimesi küçük harfle başlamıştır.'
      },
      {
        id: 'q-ebu-11-17',
        difficulty: 'medium',
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'C', text: 'Doğru söz yemin istemez.' },
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'C', text: 'Eski ve yıpranmış kıyafetler giyiyordu.' },
          { id: 'D', text: 'Gelmek istedi ancak vakti yoktu.' },
          { id: 'E', text: 'Bunu sen veya kardeşin yapmalı.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğinde "ve" bağlacı, "eski" ve "yıpranmış" sıfatlarını birbirine bağlamıştır.'
      },
      {
        id: 'q-ebu-11-20',
        difficulty: 'medium',
        ...
        options: [
          ...
          { id: 'B', text: 'Oraya kadar gitmiş de bize uğramamış.' },
          { id: 'C', text: 'Çalıştı da sınavı kazandı.' },
          { id: 'D', text: 'Büyüyecek de ailesine bakacak.' },
          { id: 'E', text: 'Kitabı okudum da pek anlamadım.' }
        ],
        correctOptionId: 'B',
        explanation: 'B seçeneğinde oraya kadar gidip de uğramaması üzerinden bir sitem ve yakınma dile getirilmiştir.'
      }
    ]
  },
  {
    id: 'test-ebu-11-zor',
    title: 'Edat Bağlaç Ünlem 11 (Zor)',
    description: 'Edat Bağlaç Ünlem - Zor (101-110)',
    type: 'comprehension',
    order: 33,
    questions: [
      {
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'D', text: 'Bunu ondan başka hiç kimse yapamaz.' },
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'B', text: 'Eyvah, yine her şeyi yüzüme gözüme bulaştırdım.' },
          { id: 'C', text: 'Zavallının ahı tuttu, işleri ters gitmeye başladı.' },
          { id: 'D', text: 'Ahlar vahlar içinde bir ömür geçirdi zavallı.' },
          { id: 'E', text: 'Vah vah, adama çok yazık oldu.' }
        ],
        correctOptionId: 'C',
        explanation: 'C seçeneğinde "ah" sözcüğü isimleşerek bir isim tamlamasında tamlanan olmuş ve cümlenin öznesi ("tuttu" eylemini yapan) görevinde kullanılmıştır.'
      },
      {
        id: 'q-ebu-11-28',
        difficulty: 'hard',
        ...
        options: [
          ...
          { id: 'D', text: 'Erken yat ki yarın sabah kalkabilesin.' },
          { id: 'E', text: 'Dışarı bir çıktım ki her yer sular altında!' }
        ],
        correctOptionId: 'E',
        explanation: 'E seçeneğinde dışarı çıkıldığında karşılaşılan manzara karşısında duyulan şaşkınlık (hayret) "ki" bağlacı ile sağlanmıştır.'
      },
      {
        id: 'q-ebu-11-29',
        difficulty: 'hard',
        ...
        options: [
          ...
          { id: 'B', text: 'Bu problemi yalnız sen çözebilirsin.' },
          { id: 'C', text: 'Yalnız insanların sorunları daha derin olur.' },
          { id: 'D', text: 'Ona güveniyorum yalnız dediklerimi yapmalı.' },
          { id: 'E', text: 'Koca evde yıllarca yalnız yaşadı.' }
        ],
        correctOptionId: 'B',
        explanation: '"Yalnız" sözcüğü "sadece" anlamında kullanıldığında edattır. B seçeneğinde "sadece sen" anlamındadır.'
      },
      {
        id: 'q-ebu-11-30',
        difficulty: 'hard',
        ...
        options: [
          ...
          { id: 'C', text: 'Senin *için* her şeyi göze alırım. (Edat)' },
          { id: 'D', text: 'Bugün hava yağmurlu *mu* olacakmış? (Bağlaç)' },
          { id: 'E', text: 'Oraya gittim *fakat* onu bulamadım. (Bağlaç)' }
        ],
        correctOptionId: 'D',
        explanation: 'D seçeneğindeki "mu" kelimesi soru edatıdır, bağlaç değildir.'
      }
    ]
  }
];
