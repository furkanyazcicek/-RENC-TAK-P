/**
 * DRKOÇ — ALMANCA İÇERİĞİ KAYIT DEFTERİ
 * ==================================================================
 *
 ...
 *
 * Bu ağaç, İngilizce bölümüyle AYNI sözleşmeyi (bkz. lib/almanca/sema.js)
 * kullanır ama kendi içeriği, kendi seslendirmesi ve kendi ilerleme kaydı
 * vardır. İki bölüm birbirinden tamamen bağımsızdır: Almanca içeriğindeki
 * bir hata İngilizce bölümünü etkilemez.
 */
...
import { KELIMELER as KELIMELER_OKUL } from './kelime/a1-okul.js'
...
export const DILLER = [
  {
    ...
    bayrak: '🇩🇪',
    durum: 'hazir',
    aciklama: 'Sıfırdan C2\'ye kadar planlanmış; A1 seviyesinin tamamı (altı modül) çalışılabilir durumda.',
  },
]
