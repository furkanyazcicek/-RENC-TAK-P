...
export const MODULLER = [
  ...
  },
  {
    ...
    kazanimlar: [
      ...
      'Saati söyler, sıklık zarflarını yerine koyar.',
    ],
    durum: 'plan',
    dersler: [],
  },
  {
    ...
    kazanimlar: ['like/love/hate + -ing yapısını kullanır.', 'Okul eşyalarını ve dersleri adlandırır.'],
    durum: 'plan',
    dersler: [],
  },
  {
    ...
    kazanimlar: ['some/any ayrımını yapar.', 'Sayılabilen ve sayılamayan isimleri ayırır.'],
    durum: 'plan',
    dersler: [],
  },
  {
    ...
    kazanimlar: ['there is / there are kullanır.', 'Yer edatlarını doğru seçer.'],
    durum: 'plan',
    dersler: [],
  },
