/**
 * DRKOÇ — DİL İÇERİĞİ KAYIT DEFTERİ
 * ==================================================================
 *
 ...
 *
 * DİL BAĞIMSIZLIĞI: kayıt defteri dil anahtarına göre kurulmuştur.
 * Bugün yalnız 'en' içeriği var. Almanca eklendiğinde `DILLER` dizisine
 * yeni bir giriş yapılır ve o dilin dersleri kendi klasöründen gelir.
 * İçeriği olmayan bir dil arayüzde HİÇ görünmez — yarım kalmış "yakında"
 * sayfası açılmaz.
 */
...
export const DILLER = [
  {
    ...
    bayrak: '🇬🇧',
    durum: 'hazir',
    aciklama: 'Sıfırdan C2\'ye kadar planlanmış, A1 başlangıç modülü çalışılabilir durumda.',
  },
]
