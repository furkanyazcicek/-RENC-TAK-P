...
export default {
  ...
  title: 'Sinir Sistemi: Ayrıntılı Temel Not',
  subtitle: 'Reseptörlerden nöron ve impulsa, sinapstan hayvanlardaki organizasyon farklarına, insan sinir sisteminden refleks ve otonom kontrole kadar bütün yapıyı mekanizmasıyla öğren.',
  ...
  document: {
    ...
    outcomes: [
      'Uyaran, reseptör, duyu nöronu, merkezî sinir sistemi, motor nöron ve efektör arasındaki bilgi akışını kurabileceksin.',
      'Mekano-, termo-, kemo-, foto- ve nosiseptörleri algıladıkları enerji veya değişim türüne göre sınıflandırabileceksin.',
      ...
      'Başlıca hayvan gruplarında sinir ağı, ganglion, sinir kordonu ve merkezî sinir sistemi düzenlerini karşılaştırabileceksin.',
    ],
...
Bu dönüşümleri görürsen sinir sistemini ezberlemezsin; soruda kanal kapansa, kök kesilse ya da nörotransmitter temizlenmese ne olacağını mekanizmadan çıkarırsın.`,
      ...
      {
        id: 'sinir-reseptorler',
        kind: 'build',
        title: 'Reseptörler: uyaran enerjisini sinir diline çevirme',
        lead: 'Sinir sistemi dış dünyayı doğrudan taşımaz; özelleşmiş reseptörler farklı enerji ve kimyasal değişimleri zar potansiyeline dönüştürür.',
        blocks: [
          {
            id: 'sinir-reseptor-prose',
            type: 'prose',
            body: `**Uyaran**, canlıda algılanabilir değişim oluşturabilen fiziksel veya kimyasal etkidir. **Reseptör**, belirli uyaran türünü algılayıp hücre zarında elektriksel veya biyokimyasal değişime dönüştüren özelleşmiş hücre ya da sinir ucudur. Bu dönüşüme **duyusal transdüksiyon** denir. Reseptör uyarıyı “beyne götürmez”; uyarının enerjisini sinir sisteminin kullanabileceği zar potansiyeli değişimine çevirir.

Bir reseptörün en düşük yanıt verdiği uyaran türü **uygun uyaran**dır. Göz fotoreseptörü ışığa, iç kulaktaki tüy hücresi mekanik harekete, tat ve koku reseptörleri kimyasal moleküllere özelleşmiştir. Çok güçlü farklı bir enerji de reseptörü uyarabilir; göze basınç uygulandığında ışık parlaması hissedilmesi, sinir sisteminin etkinleşen yolun kimliğine göre algı oluşturduğunu gösterir.

**Mekanoreseptörler** dokunma, basınç, gerilme, titreşim ve ses gibi mekanik değişimleri algılar. Derideki dokunma reseptörleri, kas–tendon konumunu bildiren proprioseptörler ve iç kulak tüy hücreleri bu gruptadır. **Termoreseptörler** sıcaklık değişimlerini; **nosiseptörler** doku hasarı oluşturabilecek mekanik, termal veya kimyasal etkileri algılar. Ağrı tek başına uyaranın özelliği değil, nosiseptif bilgiyle merkezî işlemenin oluşturduğu deneyimdir.

**Kemoreseptörler** molekül derişimi ve kimyasal bileşim değişimlerine yanıt verir. Tat ve koku reseptörleri dış çevre kaynaklı kimyasalları; kandaki O₂, CO₂ ve pH değişimini izleyen iç reseptörler iç ortamı değerlendirir. **Fotoreseptörler** ışık enerjisine duyarlıdır; omurgalı retinasındaki çubuk ve koni hücreleri ışığı kimyasal–elektriksel değişime dönüştürür.

Reseptörler bulundukları yere göre de sınıflandırılabilir. **Eksteroreseptörler** dış çevreyi; **interoreseptörler/visseroreseptörler** iç organ ve damar koşullarını; **propriyoreseptörler** kas, tendon ve eklemlerin konum–gerilme bilgisini izler. Aynı reseptör hem enerji türüne hem konumuna göre adlandırılabilir; örneğin kas iğciği mekanoreseptör ve propriyoreseptördür.

Uyaran, reseptör zarında çoğunlukla **dereceli reseptör potansiyeli** oluşturur. Uyaran güçlendikçe bu yerel potansiyelin büyüklüğü artabilir. Eşik aşılırsa bağlı duyu nöronunda aksiyon potansiyelleri başlar. Aksiyon potansiyelinin genliği değişmez; daha güçlü uyarı çoğunlukla daha yüksek impuls frekansı ve daha fazla reseptör/nöronun katılımıyla kodlanır.

Sürekli ve değişmeyen uyarıda bazı reseptörlerin yanıtının azalmasına **duyusal adaptasyon** denir. Giysi temasının bir süre sonra fark edilmemesi hızlı adaptasyona örnektir. Ağrı reseptörleri gibi koruyucu sistemler daha yavaş adapte olabilir. Adaptasyon reseptörün tamamen çalışmadığı anlamına gelmez; değişmeyen arka plan bilgisinin merkezî sisteme aktarımını azaltarak yeni değişimlerin fark edilmesini kolaylaştırır.`,
          },
          {
            id: 'sinir-reseptor-map',
            type: 'concept_map',
            title: 'Uyaran türünden sinirsel koda',
            intro: 'Fiziksel veya kimyasal değişim, reseptörde dereceli potansiyele ve sonra aksiyon potansiyeli frekansına dönüşür.',
            nodes: [
              { id: 'uyaran', label: 'Uyaran', detail: 'Işık, basınç, sıcaklık, kimyasal veya hasar' },
              { id: 'reseptor', label: 'Özelleşmiş reseptör', detail: 'Uygun uyaranı seçer' },
              { id: 'trans', label: 'Transdüksiyon', detail: 'Enerji zar değişimine çevrilir' },
              { id: 'yerel', label: 'Reseptör potansiyeli', detail: 'Yerel ve dereceli' },
              { id: 'impuls', label: 'Aksiyon potansiyeli', detail: 'Eşik sonrası ya hep ya hiç' },
              { id: 'algı', label: 'Merkezî yorum', detail: 'Yer, tür ve şiddet algısı' },
            ],
            links: [
              { from: 'uyaran', to: 'reseptor', label: 'algılanır' },
              { from: 'reseptor', to: 'trans', label: 'dönüştürür' },
              { from: 'trans', to: 'yerel', label: 'oluşturur' },
              { from: 'yerel', to: 'impuls', label: 'eşik aşılırsa' },
              { from: 'impuls', to: 'algı', label: 'duyu yollarıyla taşınır' },
            ],
            caption: 'Uyaran şiddeti aksiyon potansiyelinin genliğiyle değil, frekans ve katılan lif sayısıyla kodlanır.',
          },
          {
            id: 'sinir-reseptor-table',
            type: 'table',
            title: 'Reseptör sınıfları ve uygun uyaranları',
            columns: ['Reseptör', 'Algıladığı değişim', 'Örnek'],
            rows: [
              ['Mekanoreseptör', 'Basınç, gerilme, titreşim, ses', 'Deri, iç kulak, kas iğciği'],
              ['Termoreseptör', 'Sıcaklık', 'Deri ve merkezî sıcaklık algısı'],
              ['Kemoreseptör', 'Molekül/iyon derişimi', 'Tat, koku, kan gazı–pH'],
              ['Fotoreseptör', 'Işık', 'Retinadaki çubuk ve koniler'],
              ['Nosiseptör', 'Doku hasarı riski', 'Ağrılı mekanik, termal, kimyasal uyarı'],
            ],
            caption: 'Sınıflandırma reseptörün bulunduğu organa değil, dönüştürmeye özelleştiği enerji veya değişim türüne dayanır.',
          },
          {
            id: 'sinir-reseptor-check',
            type: 'checkpoint',
            question: 'Kasın gerilmesini ve vücut bölümünün konumunu bildiren kas iğciği hangi iki sınıfa girer?',
            hint: 'Önce algılanan enerji türünü, sonra reseptörün bilgi verdiği konumu düşün.',
            answer: 'Gerilmeyi algıladığı için mekanoreseptör; kas–eklem konumunu bildirdiği için propriyoreseptördür. Farklı sınıflandırma ölçütleri aynı reseptöre birlikte uygulanabilir.',
          },
          {
            id: 'sinir-reseptor-trap',
            type: 'trap',
            title: 'Reseptör potansiyelini aksiyon potansiyeli sanmak',
            wrong: '“Reseptörde oluşan her elektriksel değişim ya hep ya hiç ilkesine uyar.”',
            right: 'Reseptör potansiyeli çoğunlukla yerel ve derecelidir. Eşik aşılırsa duyu lifinde oluşan aksiyon potansiyeli ya hep ya hiç ilkesine uyar.',
            body: 'Şiddet bilgisi dönüşümün ilk basamağında potansiyel büyüklüğü, aksonda ise impuls frekansı biçiminde temsil edilebilir.',
          },
        ],
      },
...
Nörotransmitter etkisi enzimle parçalanma, presinaptik geri alım veya difüzyon–glia alımıyla sonlandırılır. Bu temizlik bozulursa postsinaptik reseptör gereğinden uzun uyarılabilir ya da baskılanabilir. Kimyasal sinapsta veziküller presinaptik, reseptörler postsinaptik tarafta yoğun olduğu için iletim **tek yönlüdür** ve elektriksel aksona göre sinaptik gecikme oluşturur.`,
...

      {
        id: 'sinir-hayvanlar',
        kind: 'deepen',
        title: 'Hayvanlarda sinir sistemi: ağdan merkezîleşmeye',
        lead: 'Hayvanlarda ortak iş, uyarıyı algılayıp yanıt oluşturmaktır; yapısal düzen yaşam biçimi ve vücut planına göre farklılaşır.',
        blocks: [
          {
            id: 'sinir-hayvan-prose',
            type: 'prose',
            body: `Bütün canlılar çevresel değişimlere tepki verir fakat bütün canlılarda sinir sistemi bulunmaz. Bakteri, protist, bitki ve mantarlar hücresel sinyal yollarıyla tepki oluşturur; gerçek nöron ve sinir dokusu hayvanlara özgü bir organizasyondur. Hayvanlarda da süngerler sinir hücresi ve gerçek sinir dokusu bulundurmaz; hücreler arası kimyasal ve mekanik iletişimle su akımını ve kasılmayı düzenleyebilir.

Sölenterlerde nöronlar belirgin tek bir beyin yerine vücuda yayılmış **sinir ağı** oluşturur. Uyarı birçok yöne yayılabilir; radyal vücut planı ve her yönden gelebilen uyaranlarla uyumludur. Bazı bölgelerde nöron yoğunlaşması bulunabilse de omurgalılardaki gibi merkezî beyin–omurilik düzeni yoktur.

İki yanlı simetrinin gelişmesi ve hareket yönünün belirginleşmesiyle ön uç çevreyle önce karşılaşır. Duyu yapıları ve nöronların ön bölgede yoğunlaşmasına **sefalizasyon** denir. Yassı solucanlarda baş bölgesinde ganglion ve bunu vücut boyunca izleyen boyuna sinir kordonları ile aralarındaki enine bağlantılar merdivensi görünüm oluşturur. **Ganglion**, nöron gövdelerinin merkezî sinir sistemi dışındaki veya basit hayvanlardaki düğüm biçimli topluluğudur.

Halkalı solucanlarda ön ganglionlar ve karın tarafında segmental ganglionlar taşıyan çift sinir kordonu bulunur. Her segmentin yerel devreleri bazı hareketleri düzenleyebilir; ön merkezler bütün davranışı eşgüdümler. Eklem bacaklılarda beyin ve karın tarafındaki sinir kordonu gelişmiştir; duyu organları ve ganglionlar karmaşık davranışları destekler. Segment ganglionlarının birleşmesi merkezîleşmeyi artırabilir.

Yumuşakçalarda sinir sistemi yaşam biçimine göre büyük çeşitlilik gösterir. Hareketsiz veya yavaş türlerde ganglionlar daha dağınık olabilirken aktif avcı kafadan bacaklılarda büyük beyin, gelişmiş gözler ve öğrenme kapasitesi bulunur. Bu durum sinir sistemi karmaşıklığının yalnız taksonomik sıraya değil, davranış ve duyu gereksinimine de bağlı olduğunu gösterir.

Omurgalılarda merkezî sinir sistemi sırt tarafındaki içi boş sinir tüpünden gelişen **beyin ve omurilikten** oluşur; çevresel sinirler reseptör ve efektörlerle bağlantı kurar. Balıklardan memelilere bütün omurgalılarda temel bölümler ortaktır fakat bölümlerin göreli büyüklüğü ve özelleşmesi yaşam biçimine göre değişir. Balıklarda görsel–koku merkezleri ve koordinasyon, kuşlarda uçuş koordinasyonuyla ilişkili beyincik, memelilerde bütünleştirme ve öğrenmeyle ilişkili ön beyin bölgeleri belirgin gelişebilir.

“Evrimde daha gelişmiş canlı” biçimindeki doğrusal değer yargısı yerine **organizasyon ve özelleşme farkı** kullanılmalıdır. Sinir ağı yaşadığı ortamda sölenter için işlevseldir; büyük beyin her koşulda üstünlük değil, yüksek enerji maliyeti ve karmaşık bilgi işleme kapasitesidir. Evrim önceden belirlenmiş bir hedefe doğru ilerlemez.

Hayvan sinir sistemlerindeki genel örüntü, yaygın ağdan nöron gövdelerinin ganglionlarda toplanmasına, baş bölgesinde merkezîleşmeye ve omurgalılarda beyin–omurilik düzenine doğru artan bölgesel uzmanlaşmadır. Ortak ilke ise değişmez: reseptör veya duyarlı hücre uyarıyı algılar, sinirsel devre bilgiyi işler, efektör uygun tepkiyi oluşturur.`,
          },
          {
            id: 'sinir-hayvan-map',
            type: 'concept_map',
            title: 'Sinir sisteminde organizasyon basamakları',
            intro: 'Canlı gruplarını “üstünlük” değil, nöronların dağılımı ve merkezîleşme düzeyiyle karşılaştır.',
            nodes: [
              { id: 'sunger', label: 'Sünger', detail: 'Gerçek sinir dokusu yok' },
              { id: 'ag', label: 'Sinir ağı', detail: 'Sölenter; yaygın iletim' },
              { id: 'ganglion', label: 'Ganglion ve kordon', detail: 'Solucanlar; bölgesel merkezler' },
              { id: 'sefal', label: 'Sefalizasyon', detail: 'Ön uçta duyu ve işlem yoğunlaşması' },
              { id: 'eklem', label: 'Beyin + karın kordonu', detail: 'Eklem bacaklılarda gelişmiş merkezler' },
              { id: 'omurga', label: 'Beyin + omurilik', detail: 'Omurgalılarda sırt tarafı MSS' },
            ],
            links: [
              { from: 'sunger', to: 'ag', label: 'nöronların ortaya çıkışı' },
              { from: 'ag', to: 'ganglion', label: 'yoğunlaşma' },
              { from: 'ganglion', to: 'sefal', label: 'ön uç merkezîleşmesi' },
              { from: 'sefal', to: 'eklem', label: 'uzmanlaşmış merkezler' },
              { from: 'sefal', to: 'omurga', label: 'merkezî sinir tüpü' },
            ],
            caption: 'Genel eğilim merkezîleşme ve uzmanlaşmadır; her düzen kendi vücut planı ve yaşam biçimi içinde işlevseldir.',
          },
          {
            id: 'sinir-hayvan-compare',
            type: 'compare',
            title: 'Başlıca hayvan gruplarında sinirsel düzen',
            columns: ['Sinirsel yapı', 'İşlevsel sonuç'],
            rows: [
              { label: 'Sünger', values: ['Gerçek sinir sistemi yok', 'Hücreler arası yerel iletişim'] },
              { label: 'Sölenter', values: ['Yaygın sinir ağı', 'Uyarı birçok yöne yayılabilir'] },
              { label: 'Yassı solucan', values: ['Baş ganglionu, boyuna ve enine kordonlar', 'Sefalizasyon ve yönlü hareket'] },
              { label: 'Halkalı solucan / eklem bacaklı', values: ['Beyin, karın sinir kordonu, segment ganglionları', 'Yerel kontrol ve merkezî eşgüdüm'] },
              { label: 'Omurgalı', values: ['Beyin–omurilik ve çevresel sinirler', 'Yüksek merkezîleşme, bölgesel uzmanlaşma'] },
            ],
            insight: 'Merkezîleşme artışı, uyaranların farklı kaynaklardan bütünleştirilmesini ve karmaşık motor programları kolaylaştırır.',
          },
          {
            id: 'sinir-hayvan-check',
            type: 'checkpoint',
            question: 'İki yanlı simetrili ve yönlü hareket eden hayvanlarda duyu organları ile sinir merkezlerinin ön uçta yoğunlaşmasının adı ve yararı nedir?',
            hint: 'Hareket sırasında çevreyle ilk karşılaşan bölgeyi düşün.',
            answer: 'Sefalizasyondur. Ön uç çevreyle önce karşılaştığı için reseptör ve işlem merkezlerinin burada toplanması uyaranın hızlı değerlendirilmesini ve yönlü tepkiyi kolaylaştırır.',
          },
          {
            id: 'sinir-hayvan-trap',
            type: 'trap',
            title: 'Süngerde sinir ağı bulunduğunu sanmak',
            wrong: '“En basit hayvanlarda mutlaka yaygın sinir ağı vardır.”',
            right: 'Süngerlerde gerçek nöron ve sinir dokusu yoktur. Yaygın sinir ağı sölenterlerde görülür.',
            body: 'Tepki oluşturmak için her canlıda sinir sistemi bulunması gerekmez; hücresel sinyal mekanizmaları da tepki sağlayabilir.',
          },
        ],
      },
