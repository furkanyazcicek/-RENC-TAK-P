...
Matematik fiziğin kendisi değil, fiziğin ilişki dilidir. Deney de tek başına fizik değildir; ölçümün neyi sınadığını söyleyen bir model gerekir. Fizik; **olay + ölçüm + model + sınama** birlikteliğinde çalışır.`,
          },
          {
            ...
            data: {
              mode: 'scale',
              items: [
                { label: 'Atom çekirdeği', scale: '10⁻¹⁵ m', branch: 'Nükleer fizik', detail: 'Çekirdeğin yapısı, bağlanma enerjisi ve çekirdek tepkimeleri incelenir.' },
                { label: 'Atom', scale: '10⁻¹⁰ m', branch: 'Atom fiziği', detail: 'Elektron enerji düzeyleri ve atomların ışıkla etkileşimi incelenir.' },
                { label: 'Nano yapı', scale: '10⁻⁹ m', branch: 'Katı hâl fiziği', detail: 'Malzemelerin elektriksel, manyetik ve optik özellikleri yapı ile ilişkilendirilir.' },
                { label: 'Bisiklet', scale: '10⁰ m', branch: 'Mekanik', detail: 'Denge, hareket, kuvvet ve enerji aktarımı birlikte incelenir.' },
                { label: 'Dünya', scale: '10⁷ m', branch: 'Mekanik', detail: 'Kütle çekimi, dönme ve yörünge davranışı modellenir.' },
                { label: 'Yıldız', scale: '10⁹ m', branch: 'Astrofizik', detail: 'Işınım, plazma, çekirdek tepkimeleri ve kütle çekimi birlikte açıklama üretir.' },
              ],
            },
          },
          {
